		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="addinvoicereceipt" name="addinvoicereceipt" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Update Invoice Receipt</h3>
					
					<span class="pull-right">
						<button class="btn-success add_inv_recp"  type="submit" name="add_inv_recp" id="add_inv_recp"><strong>Update</strong></button>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
									    ...
									    <input id="inv_recp_no" type="text" class="input-large uppercase" onkeyup="return codevalidation()" name="inv_recp_no" value="<?php if(isset($editinv_recp->invoice_receipt_number)){ echo $editinv_recp->invoice_receipt_number;}?>"/>
                                        <input id="inv_recp_prefix" type="hidden" name="inv_recp_prefix" value="<?php if(isset($inv_recp_Prefix)) { echo $inv_recp_Prefix; } ?>"/>
										 <input id="inv_recp_id" type="hidden" name="inv_recp_id" value="<?php if(isset($editinv_recp->invoice_receipt_id)){ echo $editinv_recp->invoice_receipt_id;}?>"/>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <input id="inv_recp_date" name="inv_recp_date" value="<?php if(($editinv_recp->invoice_receipt_date)!= "0000-00-00") { echo date('d-m-Y', strtotime($editinv_recp->invoice_receipt_date)); } ?>" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                                ...
                                <div class="row-fluid">
                                    <span class="span10">
                                       ...
                                       <div class="row-fluid input-prepend input-append">
                                        <input id="inv_recp_customer_name" name="inv_recp_customer_name" value="<?php if(isset($editinv_recp->customer_name)){ echo $editinv_recp->customer_name;}?>" readonly="readonly" type="text" class="input-large uppercase" />
									   ...
									   -->
                                         <input id="so_customer_id" name="so_customer_id" value="<?php if(isset($editinv_recp->invoice_receipt_customer_id)){ echo $editinv_recp->invoice_receipt_customer_id;}?>" type="hidden" />
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
									...
									<div class="Products_editView_fieldName_productnameformError parentFormEditView formError" style="margin-top: -30px;" id="so_customer_codeError">
                                       ...
                                       <input id="inv_recp_customer_code" readonly="readonly" name="inv_recp_customer_code"  value="<?php if(isset($editinv_recp->customer_code)){ echo $editinv_recp->customer_code;}?>" type="text" class="input-large uppercase"/>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="inv_recp_amount" name="inv_recp_amount" type="text" value="<?php if(isset($editinv_recp->invoice_receipt_amount)){ echo $editinv_recp->invoice_receipt_amount;}?>" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
									...
									<div class="Products_editView_fieldName_productnameformError parentFormEditView formError" style="margin-top: -30px;" id="customer_categoryError">
									 ...
									 <select name="inv_recp_status" class="chzn-select" id="inv_recp_status">
                                            <option <?php if(isset($editinv_recp->invoice_receipt_status)) { if($editinv_recp->invoice_receipt_status == 'draft') { ?> selected="selected" <?php } } ?> value="draft">Draft</option>
											<option <?php if(isset($editinv_recp->invoice_receipt_status)) { if($editinv_recp->invoice_receipt_status == 'onprocess') { ?> selected="selected" <?php } } ?> value="on process">On Process</option>
											<option <?php if(isset($editinv_recp->invoice_receipt_status)) { if($editinv_recp->invoice_receipt_status == 'approved') { ?> selected="selected" <?php } } ?> value="approved">Approved</option>	
											<option <?php if(isset($editinv_recp->invoice_receipt_status)) { if($editinv_recp->invoice_receipt_status == 'cancelled') { ?> selected="selected" <?php } } ?> value="cancelled">Cancelled</option>
                                        </select>
							        </span>
                                </div>
                            </td>
						...
						<tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <textarea class="row-fluid" id="inv_recp_descp" name="inv_recp_descp" ><?php echo $editinv_recp->invoice_receipt_descrption;?></textarea>
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">&nbsp;
                            ...
                            <td class="fieldValue medium" >&nbsp;
                                <div class="row-fluid">
                                    <span class="span10">
                                        <input id="cus_inc_amt" name="cus_inc_amt" readonly value="<?php echo $editinv_recp->invoice_incentive_amount;?>" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                            </td>
                        </tr>
			 ...
			 <table class="table table-bordered blockContainer showInlineTable equalSplit">
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
									...
									<select	data-selected-value="" name="inv_recp_payment_mode" class="chzn-select" id="inv_recp_payment_mode">
											 ...
											 { ?>
                                            <option value="<?php echo $PM['payment_mode_id']; ?>" <?php if($editinv_recp->invoice_receipt_payment_mode_id == $PM['payment_mode_id']) { ?> selected="selected"  <?php } ?> > <?php echo $PM['payment_mode_name']; ?> 
                                           </option>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="inv_recp_bank" name="inv_recp_bank"  value="<?php if(isset($editinv_recp->invoice_receipt_payment_bank)){ echo $editinv_recp->invoice_receipt_payment_bank;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="inv_recp_chk_no" name="inv_recp_chk_no"  value="<?php if(isset($editinv_recp->invoice_receipt_payment_check_dd_number)){ echo $editinv_recp->invoice_receipt_payment_check_dd_number;}?>"  type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
							<td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="inv_recp_chk_date" name="inv_recp_chk_date" value="<?php if(($editinv_recp->invoice_receipt_payment_check_dd_date)!= "0000-00-00") { echo date('d-m-Y', strtotime($editinv_recp->invoice_receipt_payment_check_dd_date)); } ?>"type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                ...
                <div class="row-fluid">
                    <div class="pull-right">
                        <button class="btn-success po_add_details add_inv_recp" type="submit" name="add_inv_recp" id="add_inv_recp"><strong>Update</strong></button>
                        <a class="cancelLink" type="reset" onClick="javascript:window.history.back();">Cancel</a>
                    </div>
