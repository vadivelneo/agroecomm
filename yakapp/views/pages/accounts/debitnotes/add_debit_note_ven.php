...
<section>
  ...
  <div class="rightPanel" style="padding: 14px 20px; width:96%;">
    ...
    <div class='container-fluid editViewContainer'>
      <form class="form-horizontal openingstkForm" id="openingstkForm" name="openingstkForm" method="post" action="<?php echo site_url('accounts/add_debit_note_ven')?>">
        <div class="contentHeader row-fluid">
          <h3 class="span8 textOverflowEllipsis">Add Debit Note</h3>
          <div class="pull-right">
            <button class="btn-success add_debit" type="submit" name="add_debit" id="add_debit"><strong>save</strong></button>
        ...
        <table class="table table-bordered blockContainer showInlineTable equalSplit">
          <thead>
            <tr>
              <th class="blockHeader" colspan="4">Debit Node Details</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td class="fieldValue medium">
                     ...
                     <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" style="margin-top: -30px;" id="nameError">
                                       ...
                                       <input type="hidden"  name="account_for" id="account_for" value="vendor" />
                                        ...
                                        <span id="plus_credit_details" class="add-on cursorPointer createReferenceRecord plus">
                                         ...
                                         <input id="account_type" name="account_type" type="hidden" value="debit" />
                                       </div>
                                    </span>
                                 </div>
                             </td>
...
;(function($) {
  ...
  var debit = $('#account_for').val();
  

    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('accounts/get_debit_popup'); ?>',
       data: 'debit_type='+debit,
