...
<section>
  <div class="rightPanel">
          ...
          <table>
            <tbody>
              <tr>
                ...
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Purchase Return No&nbsp;&nbsp;</a></th>
		...
		if(!empty($credit_details)) {
		 ...
		 foreach($credit_details as $Ven) { ?>
              <tr class="listViewEntries" data-id='36'  id="Leads_listView_row_1">
                <td><?php echo $Ven['purchase_return_code'];?></a></td>
                <td><?php echo $Ven['po_invoice_number'];?></a></td>
                <td><?php echo $Ven['purchase_return_total_net_amount'];?></td>
    ...
    if(!empty($credit_account)) {
      $i = 1;
     foreach($credit_account as $Ven) { ?>
              <tr class="listViewEntries" data-id='36'  id="Leads_listView_row_1">
                <td><?php echo $Ven['account_amount'];?></a></td>
                <td><?php if(($Ven['account_add_date']) != '0000-00-00' && $Ven['account_add_date'] != '' && $Ven['account_add_date'] != NULL) { ?>
                  <?php echo date('d-m-Y', strtotime($Ven['account_add_date'])); ?>
                <?php } else { ?>
                  -
         <?php } ?> </td>
         <td><?php echo $Ven['account_description'];?></a></td>
                <td><?php echo $Ven['user_name'];?></a></td>
