                        ...
                        <tr>
                            <td class="fieldLabel medium">
                                <label class="muted pull-right marginRight10px">
                                    <span class="redColor">*</span>User ID
                                </label>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="UserIdError" style="margin-top: -30px;">
                                            <div class="formErrorContent">*Please enter User ID</div>
                                            <div class="formErrorArrow"></div>
                                         </div> 
										 <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="currentUserIdError" style="margin-top: -30px;">
                                            <div class="formErrorContent">*Please enter correct User ID</div>
                                            <div class="formErrorArrow"></div>
                                         </div>
