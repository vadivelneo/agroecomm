...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <form class="form-horizontal recordEditView" id="addSalesorder" name="addSalesorder" autocomplete="off" method="post" action="<?php echo site_url('salesorder/addsalesorder')?>" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="muted pull-right marginRight10px"> <span class="redColor">*</span>Customer Name </label>
                                    <div class="row-fluid">
                                        <span class="span10">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="row-fluid">
                                        <span class="span10">
                                            <input id="so_customer_code" readonly name="so_customer_code" type="text" class="form-control input-large uppercase" />
                                        </span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="muted pull-right marginRight10px"> <span class="redColor">*</span>Division </label>
                                    <div class="row-fluid">
                                        <span class="span10">
                                            <select name="material_store_division_id" class="form-control chzn-select" id="material_store_division_id" onchange="getstore_division()">
                                                ...
                                                <option value="<?php echo $STD['division_id']; ?>"><?php echo $STD['division_name']; ?></option>
                                                <?php } } ?>
                                            </select>
                                        </span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="muted pull-right marginRight10px"> <span class="redColor">*</span>Store </label>
                                    <div class="row-fluid">
                                        <span class="span10">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="muted pull-right marginRight10px"> <span class="redColor">*</span>Incentive Amount </label>
                                    <div class="row-fluid">
                                        <span class="span10">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="pull-right">
                                    <?php /*?>
                                    <a class="btn btn-success" id="sales_singleitem" href="javascript:void(0);"><strong>Add Single Item</strong></a>
                                    <?php */?>
                ...
                <th>IGST Amount</th>-->
                                ...
                                <table class="popuptable table table-hover text-nowrap"></table>

                                <input type="hidden" value="" name="tax_group_length" id="tax_group_length" />
                                <div id="tax_group_calculation"></div>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <label class="muted pull-right marginRight10px"> <span class="redColor">*</span>Total Gross Amount </label>
                                            </td>

                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <span class="totalvalidationmsg" id="add_itemError2"></span>
                                                <input class="form-control amount_calc" name="total_gross_amount" id="total_gross_amount" type="text" readonly="readonly" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fieldLabel medium" style="width: 20%;">
                                                ...
                                                <input class="form-control  amount_calc" name="total_disocunts_amount" id="total_disocunts_amount" type="text" readonly="readonly" />
                                                <input class="amount_calc" name="total_disocunts_percentage" id="total_disocunts_percentage" type="hidden" readonly="readonly" />
                                                <?php if($tax_value == 'nontaxable') { ?>
                                                <input class="form-control amount_calc" name="total_tax_amount" id="total_tax_amount" type="hidden" value="0.00" readonly="readonly" />
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php if($tax_value != 'nontaxable') { ?>
                                        <tr>
                                            ...
                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <span class="totalvalidationmsg"></span>
                                                <input class="form-control amount_calc" name="total_tax_amount" id="total_tax_amount" type="text" readonly="readonly" />
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        <tr>
                                            ...
                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <span class="totalvalidationmsg"></span>
                                                <input class="form-control amount_calc" name="total_shipping_charges" id="total_shipping_charges" type="text" onkeyup="calculateGrandTotal(event);" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fieldLabel medium">
                                            ...
                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <span class="totalvalidationmsg"></span>
                                                <input class="form-control  amount_calc" name="total_shipping_tax" id="total_shipping_tax" type="text" readonly="readonly" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fieldLabel medium">
                                                <label class="muted pull-right marginRight10px"> <span class="redColor">*</span> Debit Amount</label>
                                            </td>

                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <span class="totalvalidationmsg" id="add_itemError1"></span>
                                                <input class="form-control  amount_calc" name="cus_wallet_debit_amt" id="cus_wallet_debit_amt" type="text" onkeyup="calculateGrandTotal(event);" />
                                            </td>
                                        </tr>

                                        <tr>
                                            <td class="fieldLabel medium">
                                                <label class="muted pull-right marginRight10px"> <span class="redColor">*</span> Total Net Amount</label>
                                            </td>

                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <span class="totalvalidationmsg" id="add_itemError1"></span>
                                                <input class="form-control amount_calc" name="grand_total" id="grand_total" type="text" readonly="readonly" />
                                            </td>
                                        </tr>

                                        <tr>
                                            <td class="fieldLabel medium">
                                                <label class="muted pull-right marginRight10px"> Total Incentive Amount</label>
                                            </td>

                                            <td class="fieldLabel medium" style="width: 20%;">
                                                <span class="totalvalidationmsg" id="add_itemError1"></span>
                                                <input
                                                    class="form-control  amount_calc"
                                                    name="total_incentive_amount"
                                                    id="total_incentive_amount"
                                                    value="<?php if(isset($so_item_total->so_grand_total_incentive)){ echo $so_item_total->so_grand_total_incentive;}?>"
                                                    type="text"
                                                    readonly="readonly"
                                                />
                                            </td>
                ...
                <div class="contentHeader row-fluid">
                    <span class="pull-right">
                        <button class="btn btn-success cus_add_details" value="Save" type="submit" name="save" id="cus_add_details"><strong>Save</strong></button>
                        <button type="reset" value="Reset" class="btn btn-primary">Reset</button>
                        <a class="btn btn-danger materialreq_add_details" type="reset" onClick="javascript:window.history.back();">Cancel</a>
                    </span>
                </div>
                <input id="login_company_id" name="login_company_id" type="hidden" value="<?php echo $login_company_id; ?>" />
                <input id="tax_value" name="tax_value" type="hidden" value="<?php echo $tax_value; ?>" />
    ...
    <section class="content">
        ...
        <div id="customerdetail_to_popup" class="pop-up-display-content multipleitemscontent"></div>
        <div id="sale_quote_to_popup" class="pop-up-display-content multipleitemscontent"></div>
    </section>
</div>
<script>
