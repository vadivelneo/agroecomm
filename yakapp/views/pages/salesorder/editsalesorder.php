...
<section>
	<div class="rightPanel" style="padding: 14px 20px; width:96%;">
		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" autocomplete="off" method="post" action="<?php echo site_url();?>/salesorder/edit_salesorder/<?php  echo $so_data->sales_order_id;?>" enctype="multipart/form-data">
                                ...
                                <div class="row-fluid">
									...
									<div class="Products_editView_fieldName_productnameformError parentFormEditView formError" style="margin-top: -30px;" id="customer_categoryError">
                                     ...
                                     <select name="so_status" class="chzn-select" id="so_status">
                                            <option value="created"  <?php if($so_data->sales_order_status == "created") { ?> selected="selected" <?php } ?>>Created</option>
                  ...
                  <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" style="margin-top: -30px;" id="so_customer_codeError">
                        ...
                        <td class="fieldLabel medium">
                            ...
                            <select name="material_store_division_id" class="chzn-select" id="material_store_division_id" onchange="getstore_division()" >
                                        ...
                                        <option value="<?php echo $STD['division_id']; ?>" <?php if($STD['division_id'] == $so_data->sales_order_item_division_id) { ?> selected="selected"  <?php } ?>  ><?php echo $STD['division_name']; ?></option><?php } } ?>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <option value="<?php echo $STR['store_id']; ?>" <?php if($STR['store_id'] == $so_data->sales_order_item_store_id) { ?> selected="selected"  <?php } ?>  ><?php echo $STR['store_name']; ?></option><?php } } ?>
                                        </select>
                                    </span>
                                </div>
                            </td>
                      ...
                      <tr>
                        <td class="fieldLabel medium">
                            ...
                            <div class="row-fluid">
                                    <span class="span10">
                                        <input id="cus_inc_amt" name="cus_inc_amt" readonly value="<?php if(isset($so_data->sales_order_incentive_amt)){ echo $so_data->sales_order_incentive_amt;}?>" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                            </td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <textarea class="row-fluid" id="purchse_ord_terms_conditions" name="purchse_ord_terms_conditions" ><?php if(isset($so_data->sales_order_termsandconditions)){ echo $so_data->sales_order_termsandconditions;}?></textarea>
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <textarea class="row-fluid" id="purchse_ord_payment_terms" name="purchse_ord_payment_terms" ><?php if(isset($so_data->sales_order_payment_terms)){ echo $so_data->sales_order_payment_terms;}?></textarea>
                                    </span>
                                 </div>
                             </td>
                        </tr>
                ...
                <?php if($tax_value != 'nontaxable') { ?>
                       ...
                       <tr>
                        <td><a href="javascript:void(0);" ><?php  echo $itemcount;  ?></a>
                                            <?php /*?>  <input id="item_code_<?php echo $itemcount; ?>" name="item_code[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['product_code'])) { echo $ITEMS['product_code']; } ?>" type="hidden" /><?php */?>
                        ...
                        <input id="item_mfg_prtno_<?php echo $itemcount; ?>" name="item_mfg_prtno[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['product_mfr_part_number'])) { echo $ITEMS['product_mfr_part_number']; } ?>" type="hidden" />
						 <input id="so_items_id_<?php echo $itemcount; ?>" name="so_items_id[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_id'])) { echo $ITEMS['so_items_id']; } ?>" type="hidden" /></td>
                      ...
                      <td><a href="javascript:void(0);" id="item_name_value_<?php echo $itemcount; ?>"><?php if(isset($ITEMS['product_name'])) { echo $ITEMS['product_name']; } ?></a>
                        ...
                        <input id="multiple_item_store_id_<?php echo $itemcount; ?>" name="multiple_item_store_id[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_store_id'])) { echo $ITEMS['so_items_store_id']; } ?>" type="hidden" />
                         <input id="multiple_item_store_name_<?php echo $itemcount; ?>" name="multiple_item_store_name[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['store_name'])) { echo $ITEMS['store_name']; } ?>" type="hidden" /></td>
                        
                        <td>
                         <a href="javascript:void(0);" ><?php if(isset($ITEMS['so_items_hsn_sac'])) { echo $ITEMS['so_items_hsn_sac']; } ?></a>
                        <input id="item_hsn_value_<?php echo $itemcount; ?>" name="item_hsn_value[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_hsn_sac'])) { echo $ITEMS['so_items_hsn_sac']; } ?>" type="hidden" class="quantity" readonly="readonly"  /></td>
                        ...
                        <input id="item_qty_<?php echo $itemcount; ?>" name="item_qty[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_ord_qty'])) { echo $ITEMS['so_items_ord_qty']; } ?>" type="text" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
						 ...
						 <td>
                        <input id="item_incentive_rate_<?php echo $itemcount; ?>" name="item_incentive_rate[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_incentive_rate'])) { echo $ITEMS['so_items_incentive_rate']; } ?>" type="text" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
						</td>
						
                      <td>
                        <input id="item_incentive_total_<?php echo $itemcount; ?>" name="item_incentive_total[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_incentive_total'])) { echo $ITEMS['so_items_incentive_total']; } ?>" type="text" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
						</td>
                        <td><input  name="item_mrp[<?php echo $itemcount; ?>]" id="item_mrp_<?php echo $itemcount;  ?>" class="quantity" readonly="readonly" value="<?php if(isset($ITEMS['so_items_mrp'])) { echo $ITEMS['so_items_mrp'];  } ?>"> </input>
                        ...
                        <input id="item_qty_free_<?php echo $itemcount; ?>" name="item_qty_free[<?php echo $itemcount; ?>]" readonly="readonly" value="<?php if(isset($ITEMS['so_items_free_qty'])) { echo $ITEMS['so_items_free_qty']; } ?>" type="hidden" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" /></td>
                        ...
                        <input id="item_priceperunit_<?php echo $itemcount; ?>" name="item_priceperunit[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_priceperunit'])) { echo $ITEMS['so_items_priceperunit']; } ?>" type="text" class="quantity" readonly="readonly" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" /></td>
                         <td>
                        <input id="item_batch_no_<?php echo $itemcount; ?>" readonly name="item_batch_no[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_batch_no'])) { echo $ITEMS['so_items_batch_no']; } ?>" type="text" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
						</td>
						 <td>
                        <input id="item_inv_qty_<?php echo $itemcount; ?>" readonly name="item_inv_qty[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_inv_qty'])) { echo $ITEMS['so_items_inv_qty']; } ?>" type="text" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
                        ...
                        <td>
                        <input id="item_gross_amount_<?php echo $itemcount; ?>" name="item_gross_amount[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_gross_amount'])) { echo $ITEMS['so_items_gross_amount']; } ?>" type="text" class="quantity" readonly="readonly" /></td>
                      ...
                      <td>
                        <input id="item_discount_amount_<?php echo $itemcount; ?>" name="item_discount_amount[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_discounts_amount'])) { echo $ITEMS['so_items_discounts_amount']; } ?>" type="text" class="quantity stock_text" readonly="readonly" /></td>
                          ...
                          <td>
                        <input id="item_gross_amount_with_disc_<?php echo $itemcount; ?>" name="item_gross_amount_with_disc[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_gross_amount_with_discount'])) { echo $ITEMS['so_items_gross_amount_with_discount']; } ?>" type="text" class="quantity" readonly="readonly" /> <input id="item_damage_discount_percentage_<?php echo $itemcount; ?>" name="item_damage_discount_percentage[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_damage_discount_perc'])) { echo $ITEMS['so_items_damage_discount_perc']; } else { echo '0';} ?>" type="hidden" class="quantity stock_text"  />
                    <input id="item_damage_discount_amount_<?php echo $itemcount; ?>" name="item_damage_discount_amount[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_damage_discount_amount'])) { echo $ITEMS['so_items_damage_discount_amount']; } else { echo '0';} ?>" type="hidden" class="quantity stock_text" />
                      ...
                      <td>
                        ...
                        <input id="item_cgst_<?php echo $itemcount; ?>" name="item_cgst[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_gst'])) { echo $ITEMS['so_items_gst']; } ?>" type="text" class="quantity stock_text" />
                       ...
                       <input id="item_cgst_amount_<?php echo $itemcount; ?>" name="item_cgst_amount[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_gst_amt'])) { echo $ITEMS['so_items_gst_amt']; } ?>" type="hidden" class="quantity stock_text" />
                        ...
                        <td>
                       <input id="item_sgst_<?php echo $itemcount; ?>" name="item_sgst[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_sgst'])) { echo $ITEMS['so_items_sgst']; } ?>" type="text" class="quantity stock_text"/>
                       ...
                       <td>
                       <input id="item_igst_<?php echo $itemcount; ?>" name="item_igst[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_igst'])) { echo $ITEMS['so_items_igst']; } ?>" type="text" class="quantity stock_text" readonly="readonly"/>
                    ...
                    <?php /*?>  <td>
                        <input id="item_net_amount_<?php echo $itemcount; ?>" name="item_net_amount[<?php echo $itemcount; ?>]" value="<?php if(isset($ITEMS['so_items_net_amount'])) { echo $ITEMS['so_items_net_amount']; } ?>" type="text" class="quantity" readonly="readonly" /></td><?php */?>
