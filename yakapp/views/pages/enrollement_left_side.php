    ...
    <div class="leftPanel">
        <div class="row-fluid">
            <div class="quickLinksDiv">
            	...
            	<h1 class="rep_new"> Enrollement Details</h1>
				
				<p class="<?php if(in_array($uri_segment_two, $sales_order_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="<?php echo site_url('genelogy/officerform'); ?>" class="quickLinks"><strong>New Enrollement</strong></a>
                </p>
				<?php if($sess_user != 1)
		{ ?>
            	<p class="<?php if(in_array($uri_segment_two, $sales_order_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
				
                	<a href="<?php echo site_url('reports/enrollment'); ?>" class="quickLinks"><strong>Direct Down line Report</strong></a>
                </p>
		...
		{ ?>
				<p class="<?php if(in_array($uri_segment_two, $get_enrollement_report)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                    <a href="<?php echo site_url('reports/enrollement_report'); ?>" class="quickLinks"><strong>Enrollement Report </strong></a>
                </p>
