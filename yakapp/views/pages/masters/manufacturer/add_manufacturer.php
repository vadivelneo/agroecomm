		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Creating New Manufacturer</h3>
					<span class="pull-right">
						<button class="btn-success save" value="Save"  type="submit" name="manufacturer_add_details" id="manufacturer_add_details"><strong>Save</strong></button>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="manu_name" name="manu_name" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <textarea id="manu_desc" name="manu_desc" type="text" class="input-large nameField" /></textarea>
                                    </span>
                                </div>
                            </td>
                        </tr>
