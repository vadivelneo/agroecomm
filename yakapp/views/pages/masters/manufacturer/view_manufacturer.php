    ...
    <div class='container-fluid editViewContainer'>
      <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
        <div class="contentHeader row-fluid">
          <h3 class="span8 textOverflowEllipsis">View Manufacturer</h3>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($manufacturerdata->manufacturer_name)){ echo $manufacturerdata->manufacturer_name;}?>
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($manufacturerdata->manufacturer_description)){ echo $manufacturerdata->manufacturer_description;}?>
                                    </span>
                                </div>
                            </td>
                        </tr>
