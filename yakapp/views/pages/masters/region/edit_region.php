		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Updating Region</h3>
					<span class="pull-right">
						<button class="btn-success save" value="Save"   type="submit" name="city_update_details" id="city_update_details"><strong>Update</strong></button>
                            ...
                            <td class="fieldValue medium" >
                               <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="region_name" name="region_name" value="<?php if(isset($region->region_name)){ echo $region->region_name;}?>" type="text" class="input-large nameField" /> 
                            </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                 <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="region_code" name="region_code" value="<?php if(isset($region->region_code)){ echo $region->region_code;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                        </tr>
