		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Update Country</h3>
					<span class="pull-right">
						<button class="btn-success save" value="save" type="submit" name="contry_udate" id="contry_udate"><strong>Update</strong></button>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="con_name" name="con_name" value="<?php if(isset($ctry->country_name)){ echo $ctry->country_name;}?>" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="con_code" name="con_code" value="<?php if(isset($ctry->country_code)){ echo $ctry->country_code;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                        </tr>
