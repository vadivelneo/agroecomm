		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">view Country</h3>
					<span class="pull-right">
						<!--<button class="btn-success save" value="save" type="submit" name="contry_udate" id="contry_udate"><strong>Save</strong></button>-->
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($ctry->country_name)){ echo $ctry->country_name;}?>
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                       ...
                                       <?php if(isset($ctry->country_code)){ echo $ctry->country_code;}?>
                                    </span>
                                </div>
                            </td>
                        </tr>
