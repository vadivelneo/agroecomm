		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Update City</h3>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="city_name" name="city_name" value="<?php if(isset($cty->city_name)){ echo $cty->city_name;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="city_code" name="city_code" value="<?php if(isset($cty->city_code)){ echo $cty->city_code;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                        </tr>
