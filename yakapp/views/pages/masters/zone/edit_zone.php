		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Updating Zone</h3>
                      ...
                      <select class="chzn-select assigned_user_id" id="region_name" name="region_name" >
                        <option value="">Select an Option</option>
                         <?php foreach($region as $Region) { 
                                ...
                                ?>
                                    <option value="<?php echo $Region['region_id']; ?>" <?php if(isset($Zone->zone_region_id)) { if($Zone->zone_region_id == $Region['region_id']) { ?> selected="selected" <?php } } ?> ><?php echo $Region['region_name']; ?></option>
                                <?php } ?>
                      </select>
                      </span></div></td>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="zone_name" name="zone_name" type="text" class="input-large nameField" value="<?php if(isset($Zone->zone_name)){ echo $Zone->zone_name;}?>"/>
                                    </span>
                                 </div>
                             </td>
                             </tr>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="zone_code" name="zone_code" type="text" class="input-large nameField" value="<?php if(isset($Zone->zone_code)){ echo $Zone->zone_code;}?>"  />
                                    </span>
                                </div>
                            </td>
                        </tr>
