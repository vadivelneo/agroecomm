        ...
        <div class='container-fluid editViewContainer'>
            <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="" enctype="multipart/form-data">
                <div class="contentHeader row-fluid">
                    <h3 class="span8 textOverflowEllipsis">Update BOM Group</h3>
                    <span class="pull-right">
                        <button class="btn-success save" value="Save"  type="submit" name="edit_bom_group" id="edit_bom_group"><strong>Update</strong></button>
                                    ...
                                    <span class="span10">
                                        <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="pro_typ_nameError" style="margin-top: -30px;">
										  ...
										  <select name="process" class="chzn-select" id="process">
                                             <?php if(isset($process_group) && !empty($process_group)) { foreach($process_group as $TYPE) { ?>
                                            <option <?php if($TYPE['processmaster_id'] == $bomgroup->processmaster_bomgroup_id) { ?> selected="selected" <?php } ?> value="<?php echo $TYPE['processmaster_id']; ?>"><?php echo $TYPE['processmaster_name']; ?></option>
                                            <?php } } ?>
                                        </select>
                                    </span>
                                 </div>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="group_name" name="group_name" value="<?php if(isset($bomgroup->bomgroup_name)){ 
										echo $bomgroup->bomgroup_name;}?>"  type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                            </td>
                        </tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="title" name="title" value="<?php if(isset($bomgroup->bomgroup_title)){ 
										echo $bomgroup->bomgroup_title;}?>"  type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="status" name="status" type="radio" value="active" <?php if(isset($bomgroup->bomgroup_stat)) { if($bomgroup->bomgroup_stat == 'active') { ?> checked="checked" <?php } }?> class="input-large nameField">&nbsp;&nbsp;Active &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input id="status" name="status" type="radio" value="deactive" <?php if(isset($bomgroup->bomgroup_stat)) { if($bomgroup->bomgroup_stat == 'deactive') { ?> checked="checked" <?php } }?> class="input-large nameField" />&nbsp;&nbsp;Deactive 
                                    </span>
                                </div>
                            </td>
						</tr>
