  ...
  <div class="rightPanel">
    ...
    <div class="row-fluid">
     <!-- <div tabindex="2" class="wrapper-dropdown-5" id="actions">Actions
      ...
      <button class="addButton" onclick='window.location.href="<?php echo site_url('masters/addcompany'); ?>"'><i class="icon-plus" ></i>&nbsp;<strong>Add Company</strong></button>
      </span>
          ...
          <table>
            <tbody>
              <tr>
                ...
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Company Name&nbsp;&nbsp;</a></th>
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Company Address&nbsp;&nbsp;</a></th>
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Tin Number&nbsp;&nbsp;</a></th>
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">CST Number&nbsp;&nbsp;</a></th>
                <th>Actions</th>
              </tr>
              <?php
    if(!empty($company)) {
     ...
     foreach($company as $COM) { ?>
              <tr>
                ...
                <td ><a href="#"><?php echo $COM['company_name'];?></a></td>
                <td ><?php echo $COM['company_address'];?></td> 
				<td ><?php echo $COM['company_tin_number'];?></td>
				<td ><?php echo $COM['company_cst_number'];?></td>
                <td colspan="3"> 
