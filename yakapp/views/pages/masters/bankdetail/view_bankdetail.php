    ...
    <div class='container-fluid editViewContainer'>
      <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="" enctype="multipart/form-data">
        <div class="contentHeader row-fluid">
          <h3 class="span8 textOverflowEllipsis">View Bank Details</h3>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($bankdata->bank_name)){ echo $bankdata->bank_name;}?>
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($bankdata->bank_desc)){ echo $bankdata->bank_desc;}?>
                                    </span>
                                </div>
                            </td>
                        </tr>
