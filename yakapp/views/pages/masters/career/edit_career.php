    ...
    <div class='container-fluid editViewContainer'>
      <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="" enctype="multipart/form-data">
        <div class="contentHeader row-fluid">
          <h3 class="span8 textOverflowEllipsis">Editing Carrier</h3>
          <span class="pull-right">
            <button class="btn-success save" value="Save"  type="submit" name="edit_career" id="edit_career"><strong>Update</strong></button>
                    ...
                    <tbody>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="career_name" name="career_name" type="text" value="<?php if(isset($career_val->shipping_carrier_name)){ echo $career_val->shipping_carrier_name;}?>" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    ...
                                    <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="career_addressError" style="margin-top: -30px;">
                                        ...
                                        <textarea id="career_address" name="career_address" class="input-large nameField"><?php if(isset($career_val->shipping_carrier_address)){ echo $career_val->shipping_carrier_address;}?></textarea>
                                    </span>
                                 </div>
                             </td>
                        </tr>
                        ...
                        <td class="fieldLabel medium">
                          ...
                          <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <textarea id="description" name="description" class="input-large nameField"><?php if(isset($career_val->shipping_carrier_descrption)){ echo $career_val->shipping_carrier_descrption;}?></textarea>
                                    </span>
                                 </div>
                             </td>
