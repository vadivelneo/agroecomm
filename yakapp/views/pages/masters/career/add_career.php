		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Creating Carrier</h3>
					<span class="pull-right">
						<button class="btn-success save" value="Save"  type="submit" name="add_career" id="add_career"><strong>Save</strong></button>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="career_name" name="career_name" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    ...
                                    <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="career_addressError" style="margin-top: -30px;">
                                        ...
                                        <textarea id="career_address" name="career_address" class="input-large nameField"></textarea>
                                    </span>
                                 </div>
                             </td>
                        </tr>
