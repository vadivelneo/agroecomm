    ...
    <div class='container-fluid editViewContainer'>
      <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
        <div class="contentHeader row-fluid">
          <h3 class="span8 textOverflowEllipsis">View UOM</h3>
             ...
             <a class="cancelLink" type="reset" onClick="javascript:window.history.back();">Cancel</a>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($uomdata->uom_name)){ echo $uomdata->uom_name;}?>
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                       ...
                                       <?php if(isset($uomdata->uom_descrption)){ echo $uomdata->uom_descrption;}?>
                                    </span>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="row-fluid">
                    <div class="pull-right">
                       <!-- <button class="btn-success save" value="save" type="submit" name="uom_edit_details" id="uom_edit_details"><strong>Save</strong></button>-->
                        <a class="cancelLink" type="reset" onClick="javascript:window.history.back();">Cancel</a>
                    </div>
