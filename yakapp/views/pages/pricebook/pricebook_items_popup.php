			...
			if(this.checked == true)
			{
					...
					else
					{
						...
						if(jQuery.inArray(popup_item_id,old_items)==-1)	 
						{
							  ...
							  var items ='<tr><td><a href="javascript:void(0);" id="item_code_value_'+counter+'">'+popup_item_code+'</a><input id="item_code_'+counter+'" name="item_code['+counter+']" value="'+popup_item_code+'" type="hidden" /><input id="item_id_'+counter+'" name="item_id['+counter+']" value="'+popup_item_id+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_mfg_prtno_value_'+counter+'">'+popup_item_mfg_prtno+'</a><input id="item_mfg_prtno_'+counter+'" name="item_mfg_prtno['+counter+']" value="'+popup_item_mfg_prtno+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_name_value_'+counter+'">'+popup_item_name+'</a><input id="item_name_'+counter+'" name="item_name['+counter+']" value="'+popup_item_name+'" type="hidden" /><input id="item_uom_id_'+counter+'" name="item_uom_id['+counter+']" type="hidden" value="'+popup_item_uom_id+'" /></td><td><input id="item_incentive_rate_'+counter+'" name="item_incentive_rate['+counter+']" value="'+popup_item_incentive_rate+'" onkeyup="return price_book_charge('+counter+')" type="text" class="quantity" /></td><td><input id="item_handling_charge_'+counter+'" name="item_handling_charge['+counter+']" onkeyup="return price_book_charge('+counter+')" value="'+popup_item_handling_charge+'" type="text" class="quantity" /></td><td><input id="item_selling_price_'+counter+'" name="item_selling_price['+counter+']" value="'+popup_item_selling_price+'" type="text" class="quantity" /></td><td><input id="item_mrp_'+counter+'" name="item_mrp['+counter+']" value="'+popup_item_product_mrp+'" type="text" class="quantity" /></td><td><input id="item_discount_percentage_'+counter+'" name="item_discount_percentage['+counter+']" value="'+popup_item_discount_percent+'" type="text" class="quantity stock_text" /></td><td><input id="item_cgst_'+counter+'" name="item_cgst['+counter+']" onkeyup="return price_book_charge('+counter+')" value="'+popup_item_cgst+'" type="text" class="quantity stock_text" /></td><td><input id="item_sgst_'+counter+'" name="item_sgst['+counter+']"  onkeyup="return price_book_charge('+counter+')" value="'+popup_item_sgst+'" type="text" class="quantity stock_text" /></td><td><input id="item_igst_'+counter+'" name="item_igst['+counter+']" onkeyup="return price_book_charge('+counter+')" value="'+popup_item_igst+'" type="text" class="quantity stock_text" /></td><td><input id="item_hsn_sac_'+counter+'" name="item_hsn_sac['+counter+']" value="'+popup_item_hsn_sac+'" type="text" class="quantity stock_text" /></td><td><input id="item_selling_price_with_tax_'+counter+'" name="item_selling_price_with_tax['+counter+']" value="'+popup_selling_price_with_tax+'" type="text" class="quantity stock_text" /></td></tr>';
...
function multiple_pricebook_itmesearch()
	{
		   ...
		   $.ajax({
			type: 'POST',
			url: '<?php echo site_url('pricebook/search_multiple_pricebook_itemdetails'); ?>',
			data: {pricebook: pricebook_id, item_code: search_item_code, item_name: search_item_name, item_mfg_prtno: search_item_mfg_prtno},
      ...
      <table style="width:60%;">
      	<tr>
            <td>
            	Item Code :
            <br /><br />
            	<input type="text" value="" name="search_multiple_item_code" class="input-large" onkeyup="multiple_pricebook_itmesearch()" id="search_multiple_item_code">
                <span id="auto_complete_item_code"></span>
            </td>
            <td>
            	Item Description :
            <br /><br />
            	<input type="text" value="" name="search_multiple_item_name" class="input-large" onkeyup="multiple_pricebook_itmesearch()" id="search_multiple_item_name">
                <span id="auto_complete_item_name"></span>
            </td> 
			<td>
            	SKU :
            <br /><br />
            	<input type="text" value="" name="search_multiple_item_mfg_prtno" class="input-large" onkeyup="multiple_pricebook_itmesearch()" id="search_multiple_item_mfg_prtno">
