        ...
        <div id="wrap" class="animsition">
            ...
            <div class="page page-core page-login">
				...
				<div class="sessionMsg" id="ErrorMsg" style="text-align: center; color: red;"><?php echo $this->session->flashdata('message'); ?></div>
                    ...
                    <h2 class="text-light text-greensea"><img style="width:180px;height:90px;" src="<?php echo base_url(); ?>resources/images/erp_logo.png"></h2>
<?php //echo $this->uri->segment(3); exit; ?>
                    <form name="form" method="POST" class="form-validation mt-20" action="<?php echo site_url('signin/login/'); ?><?php echo "/".$this->uri->segment(3); ?>" novalidate="">
                        ...
                        <div class="form-group text-left mt-20">
						  <button class="btn btn-greensea b-0 br-2 mr-5" type="submit" name="signin" id="signin">Sign in</button>
							...
							<a href="<?php echo base_url(); ?>index.php/signin/forgot_password" class="pull-right mt-10">Forgot Password?</a>
