...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
 ...
 <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Enrollement Report</strong></h1>                                    
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<button style="margin-bottom:15px;" type="submit" name="view_report" class="btn btn-green">Level 1 - <?php if(!empty($po_list)) { echo count($po_list); }  ?></button>
...
<td><?php echo $i;?></td>
<td><?php echo $PO['OFCR_USR_VALUE'];?></td>
<td style="color: red;" class="summary_child1" id="summary_report1_<?php echo $i; ?>"> </td>
<td class="summary_child1" id="summary_report_<?php echo $i; ?>"> </td>

<td><?php echo $PO['OFCR_FST_NME'].' '.$PO['OFCR_LST_NME'];?></td>


<!--<td><?php echo $PO['rank'];?></td> -->
<td><?php echo $PO['OFCR_TRE_SPNCR_ID'];?></td>
<td><?php echo date('d-m-Y', strtotime($PO['OFCR_ADD_DT']));;?></td>
