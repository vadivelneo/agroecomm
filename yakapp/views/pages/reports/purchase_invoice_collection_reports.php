...
<section>
	<div class="rightPanel">
		<div class="row-fluid">
			<form class="form-horizontal " id="stockForm" name="stockForm" method="post" action="<?php echo site_url('reports/purchase_collection_reportssearch'); ?>" enctype="multipart/form-data"> 
        ...
        <div class="table_head" id="table">
			<div class="col w10 last summary_child" >
                ...
                <div style="width:100%;font-weight:bold;">
                    ...
                    <div class="summary_div_pur">Purchase Invoice no.
                    </div>
                    <div class="summary_div_pur">Invoice Date
                    </div>
                    <div class="summary_div_pur">Vendor Name
                    </div>
                    <div class="summary_div_pur amt_right">Invoice Amount
                    </div>
                    <div class="summary_div_pur amt_right">Collection Amount
                    </div>
                    <div class="summary_div_pur amt_right">Due Amount
                    </div>
                    </div>
                    <?php
                    ...
                    <div class="summary_child_cont">
					 <div class="summary_div_pur"><a href="javascript:void(0)">
                    ...
                    <div class="summary_div_pur amt_right"><a href="javascript:void(0)">
											<?php echo $SI['payment_payment_invoice_amount'];?>
										</a>
                    </div>
                    <div class="summary_div_pur amt_right"><a href="javascript:void(0)">
											<?php echo $SI['payment_payment_paid_amount'];?>
										</a>
                    </div>
                    <div class="summary_div_pur amt_right"><a href="javascript:void(0)">
											<?php echo $SI['payment_payment_due_amount'];?>
										</a>
                    </div>
