...
<section>
  <div class="rightPanel">
    ...
    <div class="p-popup">
      ...
      <form  method="post" name="stockForm" class="form-horizontal " action="<?php echo site_url('reports/customer_credit_note_search'); ?>"  enctype="multipart/form-data">
	 ...
	 //print_r($sales_item_list); exit;
			if(!empty($invoice_list) || (!empty($credit_note))) { ?>
				<form class="form-horizontal " id="stockForm" name="stockForm" method="post" action="<?php echo site_url('reports/customer_credit_note_search'); ?>" enctype="multipart/form-data">
    ...
    <div class="col w10 last invent_col">
    	<h2 class="invent_title">Sales Return</h2>
      ...
      <div class="col w10 last invent_tables" style="margin:6px;">
        ...
        <div class="content">
          <table>
            <tbody>
              <tr>
                <th nowrap=""><a class="listViewHeaderValues" href="javascript:void(0);">Return no.&nbsp;&nbsp;</a></th>
                <th nowrap=""><a class="listViewHeaderValues" href="javascript:void(0);">Return Date&nbsp;&nbsp;</a></th>
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Customer Name&nbsp;&nbsp;</a></th>
                <th nowrap=""><a class="listViewHeaderValues" href="javascript:void(0);">Return Amount&nbsp;&nbsp;</a></th>
			...
			<tbody id="items_list">
                ...
                <tr>
                  <td> <?php if(isset($SA_ITM['sales_return_code'])) { echo $SA_ITM['sales_return_code']; } ?> </td>
                   <td>
										<?php 
											if(($SA_ITM['sales_return_date']) != '0000-00-00' && $SA_ITM['sales_return_date'] != '' && $SA_ITM['sales_return_date'] != NULL)
											{ 
												echo date('d-m-Y', strtotime($SA_ITM['sales_return_date']));
											}
											else
											{
												echo "-";
                  ...
                  <td class="amt_right">  <?php if(isset($SA_ITM['sales_return_total_net_amount'])) { echo $SA_ITM['sales_return_total_net_amount']; } ?> </td>
				 ...
				 ?>
                  <td>  </td>
                   <td>  </td>
                    <td>  </td>
                  <td class="amt_right"> <?php if(isset($total_values->return_total)) { echo $total_values->return_total; } ?> </td>
                  <?php
    ...
    <div class="col w10 last invent_col">
    	<h2 class="invent_title">Customer Credit</h2>
        <div class="invent_qty">
          ...
          <table>
            <tbody>
			 ...
			 <tbody id="items_list">
                <?php
				//echo "<pre>";
				//print_r($credit_note); exit;
				 if(!empty($credit_note)) { $itemcount = 1; foreach($credit_note as $PI_ITM) {  ?>
                <tr>
				...
				//$debit = $debit_note_debit_total->DBT_AMT;
				//$credit = $debit_note_credit_total->CRD_AMT;
				/*if($debit > $credit)
				{
					$total = $debit - $credit;
				}
				else
				{
				 ...
				 ?>
                  <td>  </td>
                  <td>  </td>
                    <td class="amt_right"><?php if(isset($credit_note_total->credit_total)) { echo $credit_note_total->credit_total; } ?> </td>
                    <td>  </td>
