...
<section>
  <div class="rightPanel">
   ...
   <div class="p-popup">
        ...
        <form class="form-horizontal " id="stockForm" name="stockForm" method="post" action="<?php echo site_url('reports/stock_detailed_search'); ?>" enctype="multipart/form-data"> 
        <div tabindex="3" class="report" id="report" style="padding:1%;"> 
          ...
          <p class="report_p"> To date : </p>
           ...
           <input type="text"  style="width:120px;" name="report_control_no" class="input-large report_from" id="report_control_no" value="<?php if(isset($control_no)){ echo $control_no; }?>" placeholder="Control No."/>
        ...
        <input type="hidden" name="report_from" value="<?php if(isset($report_from)) { if(($report_from) != '0000-00-00' && $report_from != '' && $report_from != NULL){ echo date('d-m-Y', strtotime($report_from)); } } ?>">
                    ...
                    <input type="hidden" name="search_item_status" value="<?php if(isset($search_item_status)){ echo $search_item_status; }?>" />
                     <input type="hidden"  style="width:120px;" name="report_item_name" class="input-large report_from" id="report_item_name" value="<?php if(isset($product_name)){ echo $product_name; }?>"/>
                        <input type="hidden"  style="width:120px;" name="report_control_no" class="input-large report_from" id="report_control_no" value="<?php if(isset($control_no)){ echo $control_no; }?>"/>
