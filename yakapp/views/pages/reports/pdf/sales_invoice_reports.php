...
header('Content-Disposition: attachment;filename="salesinvoice_'.date('d-M-Y').'.xls"');
...
<table cellspacing="1" cellpadding="1" border="1" width="100%">
    <tr>
    	<td colspan="9" bgcolor="#b1ad78" >
    		<div align="center"><strong>Sales Invoice Report</strong></div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="10%"  bgcolor="#bcbcbc"><div align="left"><b>Sales Invoice No</b></div></td>
        <?php if($sess_user_group == '1') { ?>
        <td width="10%"  bgcolor="#bcbcbc"><div align="left"><b>Company</b></div></td>
        <?php } ?>
    	<td width="25%"  bgcolor="#bcbcbc"><div align="left"><b>Customer Name</b></div></td>
        <td width="20%"  bgcolor="#bcbcbc"><div align="left"><b>Sales Representative</b></div></td>
    ...
    <tr>
    	...
    	<td><div align="left"><?php echo $SI['sale_invoice_no'];?></div></td>
       	<?php if($sess_user_group == '1') { ?>
        <td><div align="left"><?php echo $SI['company_short_name'];?></div></td>
        <?php } ?>
