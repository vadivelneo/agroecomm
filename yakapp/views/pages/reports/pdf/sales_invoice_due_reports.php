...
header('Content-Disposition: attachment;filename="sales_due_reports'.date('d-M-Y').'.xls"');
...
<table cellspacing="1" cellpadding="1" border="1" width="100%">
    ...
    <tr>
        ...
        <td width="20%"  bgcolor="#CD853F"><div align="right"><b>Age Of Due(in days)</b></div></td>
    </tr>
    ...
    <tr>
        ...
        <td>
        	<div align="left">
				...
				<?php 
					$date2 = date('Y-m-d');
					//$date2 = $SI['sale_invoice_payment_date']; 
					$date1 = $SI['sale_invoice_add_date'];   
        ...
        <td align="right"><div align="right"><?php echo $days;?></div></td>
    </tr>
    <tr>
