...
<section>
	<div class="rightPanel">
		<div class="row-fluid">
			<form class="form-horizontal " id="stockForm" name="stockForm" method="post" action="<?php echo site_url('reports/po_excesssearch'); ?>" enctype="multipart/form-data"> 
				<div tabindex="3" class="report" id="report" style="padding:1%;">
					...
					<input type="text" name="report_store" placeholder="Store Name" class="input-large report_to" id="report_store" value="<?php if(isset($store_name)){ echo $store_name; }?>">
           ...
           <?php /*?> <select name="search_item_status" class="chzn-select" id="search_item_status" style="width:115px"  >
        ...
        <div class="table_head" id="table">
			<div class="col w10 last summary_child">
				...
				<div style="width:100%;font-weight:bold;">
                    ...
                    <div class="summary_div_excess">PO No.
                    </div>
                    <div class="summary_div_excess">PO Date.
                    </div>
                    <div class="summary_div_excess">Party Name
                    </div>
                    <div class="summary_div_excess">GRN No.
                    </div>
                    <div class="summary_div_excess">GRN Date.
                    </div>
                     <div class="summary_div_excess">Material Name 
                    </div>
                   
                    <div class="summary_div_excess">HSN
                    </div> 
					<div class="summary_div_excess">UOM
                    </div>
					<div class="summary_div_excess">Ordered Qty
                    </div>
                    <div class="summary_div_excess">Received Qty
                    </div>
                    <div class="summary_div_excess">Excess Qty
                    </div>
                     <div class="summary_div_excess">Price
                    </div>
                     <div class="summary_div_excess">Value
                    </div>
                                       </div>
				  ...
				  <?php
					 ...
					 <div class="summary_div_excess" ><a href="javascript:void(0)" >
                                        ...
                                        <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php 
                                        if(($PO['po_trans_date']) != '0000-00-00' && $PO['po_trans_date'] != '' && $PO['po_trans_date'] != NULL)
                                        { 
					 ...
					 <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php if($PO['po_indent_number']) { echo $PO['po_indent_number']; } else {echo "-";}?>
										</a>
                    </div>
                     <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php if($PO['po_indent_date']) { echo $PO['po_indent_date']; } else {echo "-";}?>
										</a>
                    </div>
					 <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php  if($PO['po_indent_item_name']) { echo $PO['po_indent_item_name']; } else {echo "-";}?>
										</a>
                    </div>
					
					 <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php  if($PO['po_indent_item_hsn_san']) { echo $PO['po_indent_item_hsn_san']; } else {echo "-";}?>
										</a>
                    </div>
					 ...
					 <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php   if($PO['po_indent_order_qty']) {echo $PO['po_indent_order_qty']; } else {echo "-";}?>
										</a>
                    </div>
                     <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php  if($PO['po_indent_received_qty']) { echo $PO['po_indent_received_qty']; } else {echo "-";}?>
										</a>
                    </div>
                     <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php  if($PO['po_indent_extra_qty']) { echo $PO['po_indent_extra_qty']; } else {echo "-";}?>
										</a>
                    </div>
                     <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php   if($PO['po_indent_item_price']) {echo $PO['po_indent_item_price']; } else {echo "-";}?>
										</a>
                    </div>
                     <div class="summary_div_excess" ><a href="javascript:void(0)" >
											<?php   if($PO['po_indent_extra_qty']) {echo ($PO['po_indent_extra_qty'] * $PO['po_indent_item_price']); } else {echo "-";}?>
										</a>
                    </div>
