			...
			if(this.checked == true)
			{
					...
					else
					{
						...
						if(jQuery.inArray(popup_item_id,old_items)==-1)	
						{
							...
							//alert(popup_item_discount_amount); class
							...
							if(tax_value != 'nontaxable')
							{
							  var items ='<tr><td><a href="javascript:void(0);" >'+counter+'</a><input id="multiple_item_product_code_'+counter+'" name="multiple_item_product_code['+counter+']" value="'+popup_item_product_code+'" type="hidden" /><input id="item_mfg_prtno_'+counter+'" name="item_mfg_prtno['+counter+']" value="'+popup_item_mfg_prtno+'" type="hidden" /><input id="item_code_'+counter+'" name="item_code['+counter+']" value="'+popup_item_code+'" type="hidden" /><input id="item_id_'+counter+'" name="item_id['+counter+']" value="'+popup_item_id+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_name_value_'+counter+'">'+popup_item_name+'</a><input id="item_name_'+counter+'" name="item_name['+counter+']" value="'+popup_item_name+'" type="hidden" /></td><td><input id="item_qty_'+counter+'"  class="form-control ispriceqty quantity stock_text" name="item_qty['+counter+']" value="'+popup_item_qty+'" type="text"  onkeyup="return sales_items_grid_total(event, '+counter+')" /><input id="free_qty_name'+counter+'" class="form-control w-100 quantity " name="free_qty_name['+counter+']" value="-" type="hidden"  /><input id="item_qty_free_'+counter+'" class="form-control w-100 quantity stock_text" name="item_qty_free['+counter+']" value="'+popup_item_incentive_rate+'" type="hidden" readonly="readonly" /></td><td><input id="item_incentive_rate_'+counter+'"  class="form-control w-100 quantity stock_text" name="item_incentive_rate['+counter+']" value="'+popup_item_incentive_rate+'" type="text"  onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_incentive_total_'+counter+'"  class="form-control w-100 quantity stock_text" name="item_incentive_total['+counter+']" value="'+popup_item_incentive_total+'" type="text"  onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_uom_id_'+counter+'" name="item_uom_id['+counter+']" type="hidden" value="'+popup_item_uom_id+'" /><input id="item_uom_name_'+counter+'" name="item_uom_name['+counter+']" type="hidden" value="'+popup_item_uom_name+'" /><input id="item_mrp_'+counter+'" name="item_mrp['+counter+']"  type="text" class="form-control ispriceqty quantity " value="'+popup_item_mrp+'" /></td><td><input id="item_priceperunit_'+counter+'" name="item_priceperunit['+counter+']" value="'+popup_item_priceperunit+'" type="text" class="form-control ispriceqty quantity" onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_batch_no_'+counter+'" name="item_batch_no['+counter+']" value="'+popup_item_batch_no+'" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_inv_qty_'+counter+'" name="item_inv_qty['+counter+']" value="'+popup_item_inv_qty+'" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_inv_id_'+counter+'" name="item_inv_id['+counter+']" value="'+popup_item_inv_id+'" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_gross_amount_'+counter+'" name="item_gross_amount['+counter+']" value="'+popup_gross_amount+'" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_discount_percent_'+counter+'" name="item_discount_percent['+counter+']" value="'+popup_item_discount_percent+'" type="text" class="form-control w-100 quantity stock_text"  /></td><td><input id="item_discount_amount_'+counter+'" name="item_discount_amount['+counter+']" value="'+popup_item_discount_amount+'" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_damage_discount_percentage_'+counter+'" name="item_damage_discount_percentage['+counter+']" value="'+popup_item_damage_discount_percent+'" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_damage_discount_amount_'+counter+'" name="item_damage_discount_amount['+counter+']" value="'+popup_item_damage_discount_amount+'" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_gross_amount_with_disc_'+counter+'" name="item_gross_amount_with_disc['+counter+']" value="" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_net_amount_'+counter+'" name="item_net_amount['+counter+']" value="'+item_net_amount+'" type="hidden" class="quantity" readonly="readonly" /></td><td><input id="item_tax_percent_'+counter+'" name="item_tax_percent['+counter+']" value="'+item_tax_percent+'" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_cgst_'+counter+'" name="item_cgst['+counter+']" value="'+popup_item_gst+'" type="text"  class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_tax_amount_'+counter+'" name="item_tax_amount['+counter+']" value="0" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_cgst_amount_'+counter+'" name="item_cgst_amount['+counter+']" value="0" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_sgst_'+counter+'" name="item_sgst['+counter+']" value="'+popup_item_sgst+'" type="text" readonly="readonly" class="form-control w-100 quantity stock_text"  /><input id="item_sgst_amount_'+counter+'" name="item_sgst_amount['+counter+']" value="0" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_igst_'+counter+'" name="item_igst['+counter+']" value="'+popup_item_igst+'" type="hidden" readonly="readonly" class="form-control w-100 quantity stock_text"  /><input id="item_igst_amount_'+counter+'" name="item_igst_amount['+counter+']" value="0" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td colspan="2"><div class="itemsgrid_action itemsgrid_delete" id="itemsgrid_delete_'+counter+'" onclick="return itemsgridrowdelete('+counter+');" data-item="'+popup_item_id+'" data-delete="'+counter+'" title="Delete"><span class="fa fa-trash"></span></div></td></tr>';
							}
							else
							{
								var items ='<tr><td><a href="javascript:void(0);" >'+counter+'</a></td><td><a href="javascript:void(0);">'+popup_item_product_code+'</a><input id="multiple_item_product_code_'+counter+'" name="multiple_item_product_code['+counter+']" value="'+popup_item_product_code+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_mfg_prtno_value_'+counter+'">'+popup_item_mfg_prtno+'</a><input id="item_mfg_prtno_'+counter+'" name="item_mfg_prtno['+counter+']" value="'+popup_item_mfg_prtno+'" type="hidden" /><input id="item_code_'+counter+'" name="item_code['+counter+']" value="'+popup_item_code+'" type="hidden" /><input id="item_id_'+counter+'" name="item_id['+counter+']" value="'+popup_item_id+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_name_value_'+counter+'">'+popup_item_name+'</a><input id="item_name_'+counter+'" name="item_name['+counter+']" value="'+popup_item_name+'" type="hidden" /></td><td><a href="javascript:void(0);" id="multiple_item_division_id_'+counter+'">'+popup_item_division_name+'</a><input id="multiple_item_division_id_'+counter+'" name="multiple_item_division_id['+counter+']" value="'+popup_item_division_id+'" type="hidden" /><input id="multiple_item_division_name_'+counter+'" name="multiple_item_division_name['+counter+']" value="'+popup_item_division_name+'" type="hidden" /></td><td><a href="javascript:void(0);" id="multiple_item_store_id_'+counter+'">'+popup_item_store_name+'</a><input id="multiple_item_store_id_'+counter+'" name="multiple_item_store_id['+counter+']" value="'+popup_item_store_id+'" type="hidden" /><input id="multiple_item_store_name_'+counter+'" name="multiple_item_store_name['+counter+']" value="'+popup_item_store_name+'" type="hidden" /></td><td><a href="javascript:void(0);">'+popup_item_hsn+'</a><input id="item_hsn_value_'+counter+'" name="item_hsn_value['+counter+']" value="'+popup_item_hsn+'" type="hidden" /></td><td><input id="item_qty_'+counter+'" class="form-control ispriceqty quantity stock_text" name="item_qty['+counter+']" value="'+popup_item_qty+'" type="text" onkeyup="return sales_items_grid_total(event, '+counter+')" /><input id="free_qty_name'+counter+'" class="form-control w-100 quantity " name="free_qty_name['+counter+']" value="-" type="hidden" readonly="readonly" /><input id="item_qty_free_'+counter+'" class="form-control w-100 quantity stock_text" name="item_qty_free['+counter+']" value="'+popup_item_qty+'" type="hidden" readonly="readonly" /></td><td><input id="item_uom_id_'+counter+'" name="item_uom_id['+counter+']" type="hidden" value="'+popup_item_uom_id+'" /><input id="item_uom_name_'+counter+'" name="item_uom_name['+counter+']" type="hidden" value="'+popup_item_uom_name+'" /><input id="item_mrp_'+counter+'" name="item_mrp['+counter+']" readonly="readonly" type="text" class="form-control ispriceqty quantity " value="'+popup_item_mrp+'" /></td><td><input id="item_priceperunit_'+counter+'" name="item_priceperunit['+counter+']" value="'+popup_item_priceperunit+'" type="text" readonly="readonly" class="form-control ispriceqty quantity" onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_gross_amount_'+counter+'" name="item_gross_amount['+counter+']" value="'+popup_gross_amount+'" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_discount_percent_'+counter+'" name="item_discount_percent['+counter+']" value="'+popup_item_discount_percent+'" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_discount_amount_'+counter+'" name="item_discount_amount['+counter+']" value="'+popup_item_discount_amount+'" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_damage_discount_percentage_'+counter+'" name="item_damage_discount_percentage['+counter+']" value="'+popup_item_damage_discount_percent+'" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_damage_discount_amount_'+counter+'" name="item_damage_discount_amount['+counter+']" value="'+popup_item_damage_discount_amount+'" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_gross_amount_with_disc_'+counter+'" name="item_gross_amount_with_disc['+counter+']" value="" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_net_amount_'+counter+'" name="item_net_amount['+counter+']" value="'+item_net_amount+'" type="hidden" class="form-control w-100 quantity" readonly="readonly" /></td><td><input id="item_tax_percent_'+counter+'" name="item_tax_percent['+counter+']" value="'+item_tax_percent+'" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_cgst_'+counter+'" name="item_cgst['+counter+']" value="'+popup_item_gst+'" type="text"  class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_tax_amount_'+counter+'" name="item_tax_amount['+counter+']" value="0" type="hidden" class="form-control w-100 quantity stock_text" readonly="readonly" /><input id="item_cgst_amount_'+counter+'" name="item_cgst_amount['+counter+']" value="0" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td><input id="item_sgst_'+counter+'" name="item_sgst['+counter+']" value="'+popup_item_sgst+'" type="text" readonly="readonly" class="form-control w-100 quantity stock_text"  /></td><td><input id="item_sgst_amount_'+counter+'" name="item_sgst_amount['+counter+']" value="0" type="text" class="form-control w-100 quantity stock_text" readonly="readonly" /></td><td colspan="2"><div class="itemsgrid_action itemsgrid_delete" id="itemsgrid_delete_'+counter+'" onclick="return itemsgridrowdelete('+counter+');" data-item="'+popup_item_id+'" data-delete="'+counter+'" title="Delete"><span class="fa fa-trash"></span></div></td></tr>';
							}
...
<div class="p-popup" style='background: #e8cdcd;'>
  ...
  <p>Multiple Items</p>
  <ul style="top:140px;">
     <li><a class="insert btn btn-warning"  id="btnmultipleSave" href="#">Insert</a></li>
  </ul>
  </div>
          ...
          <table class='table table-hover text-nowrap'>
            <thead>
              <tr>
				...
				<th width="65px">Incentive Rate</th>
				<th width="65px">Incentive total</th>
                 <th width="100px">Price/Unit</th>
                <th width="60px">Discount (%)</th>	
              <!--  <th width="60px">Damage Discount (%)</th>	-->
                <?php
				...
				{ 
					if($tax_value != 'nontaxable') 
					{ 
					if($gst_display_mode == 'yes' && $tax_type == 'gst' ) { ?>
					...
					if($tax_value != 'nontaxable') 
					{ 
					if($gst_display_mode == 'yes' && $tax_type == 'igst' ) { ?>
            ...
            <tbody id="multiple_items">
              ...
              <input id="multiple_item_name_<?php echo $itemcount; ?>" name="multiple_item_name[<?php echo $itemcount; ?>]" value="<?php if(isset($PROLST['product_name'])) { echo $PROLST['product_name']; } ?>" type="hidden" />
               ...
               <td>
              <input style="width:80px" id="inventory_batch_no_<?php echo $itemcount; ?>" name="inventory_batch_no[<?php echo $itemcount; ?>]" value="<?php if(isset($PROLST['inventory_control_no'])) { echo $PROLST['inventory_control_no']; } ?>" type="text" readonly />
              </td>
			  
			    <td>
            <input id="multiple_item_inv_qty_<?php echo $itemcount; ?>" readonly  class="quantity stock_text" name="multiple_item_inv_qty[<?php echo $itemcount; ?>]" type="text" value="<?php if(isset($PROLST['inventory_qty'])) { echo $PROLST['inventory_qty']; } ?>" />
              </td>
              ...
              <input style="width:80px" id="multiple_item_mrp_<?php echo $itemcount; ?>" readonly="readonly" name="multiple_item_mrp[<?php echo $itemcount; ?>]" type="text" value="<?php if(isset($PROLST['price_book_price_mrp'])) { echo $PROLST['price_book_price_mrp']; } ?>" />
              </td>
               <td>
			  ...
			  <td>
			<input id="multiple_incentive_rate_<?php echo $itemcount; ?>" name="multiple_incentive_rate[<?php echo $itemcount; ?>]" value="<?php if(isset($PROLST['price_book_price_incentive_rate'])) { echo $PROLST['price_book_price_incentive_rate']; } ?>" type="text" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
			</td>

			<td>
			<input id="multiple_incentive_total_<?php echo $itemcount; ?>" name="multiple_incentive_total[<?php echo $itemcount; ?>]" value="" type="text" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
			</td>
               <td>
			  ...
			  <?php
				...
				{ 
					...
					<td>
					<input id="multiple_item_cgst_<?php echo $itemcount; ?>" class="quantity stock_text" name="multiple_item_cgst[<?php echo $itemcount; ?>]" type="text" value="<?php if(isset($PROLST['price_book_price_gst'])) { echo $PROLST['price_book_price_gst']; } ?>" readonly="readonly" />
					</td>
                    <td>
					<input id="multiple_item_sgst_<?php echo $itemcount; ?>" class="quantity stock_text" name="multiple_item_sgst[<?php echo $itemcount; ?>]" type="text" value="<?php if(isset($PROLST['price_book_price_sgst'])) { echo $PROLST['price_book_price_sgst']; } ?>" readonly="readonly" />
					</td>
					...
					<?php  if($gst_display_mode == 'yes'  && $tax_type == 'igst') { ?>
                     ...
                     <td>
					<input id="multiple_item_igst_<?php echo $itemcount; ?>" class="quantity stock_text" name="multiple_item_igst[<?php echo $itemcount; ?>]" type="text" value="<?php if(isset($PROLST['price_book_price_igst'])) { echo $PROLST['price_book_price_igst']; } ?>" readonly="readonly" />
					</td>
