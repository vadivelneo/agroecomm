    ...
    <div class="leftPanel">
        <div class="row-fluid">
            ...
            <!--	<p class="<?php if(in_array($uri_segment_two, $sales_order_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="<?php echo site_url('reports/salesorder_list'); ?>" class="quickLinks"><strong>Self Purchase</strong></a>
                </p> -->
		...
		<p class="<?php if($uri_segment_first == 'instant_salesinvoice') { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>"><a href="<?php echo site_url('salesorder'); ?>" class="quickLinks"><strong>Self Purchase</strong></a></p><?php }} ?>
             ...
             <p class="<?php if(in_array($uri_segment_two, $sales_incentive_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
               
                	<a href="<?php echo site_url('reports/sales_incentive_report'); ?>" class="quickLinks"><strong>Incentive Report </strong></a>
                </p> 
