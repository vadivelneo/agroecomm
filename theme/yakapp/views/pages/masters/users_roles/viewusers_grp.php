		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">View User Group</h3>
					<span class="pull-right">
						<!--<button class="btn-success save" value="Save"  type="submit" name="update_users_grp" id="update_users_grp"><strong>Save</strong></button>-->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($usr_grp->group_name)){ echo $usr_grp->group_name;}?>
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        <?php if(isset($usr_grp->group_description)){ echo $usr_grp->group_description;}?>
                                    </span>
                                </div>
                            </td>
                        </tr>
