		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Creating New Location</h3>
					<span class="pull-right">
						<button class="btn-success save" value="Save"  type="submit" name="con_loc_add_details" id="con_loc_add_details"><strong>Save</strong></button>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="con_location" name="con_location" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                     ...
                                     <input type="text" class="input-large" id="con_number" name="con_number" maxlength="10"/>
                                    </span>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <textarea id="con_address" name="con_address" type="text" class="input-large nameField" /></textarea>
                                    </span>
                                </div>
                            </td>
                        </tr>
