		...
		<div class='container-fluid editViewContainer'>
            ...
            <br />
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Creating BOM Category Type</h3>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="bom_cat_type_name" name="bom_cat_type_name" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                             <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <textarea id="cat_type_descname" name="cat_type_descname" class="input-large nameField"></textarea>
                                    </span>
                                </div>
                            </td>
                        </tr>
