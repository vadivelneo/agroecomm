...
<section>
  <div class="rightPanel">
    ...
    <div class="row-fluid">
      ...
      <button class="addButton" onclick='window.location.href="<?php echo site_url('masters/addproducttype'); ?>"'><i class="icon-plus" ></i>&nbsp;<strong>Add Courier Type</strong></button>
      </span>
      <form class="form-horizontal recordEditView" id="stockForm" name="stockForm" method="post" action="<?php echo site_url('masters/search_producttype'); ?>" enctype="multipart/form-data"> 
       <div tabindex="3" class="wrapper_search" id="wrapper_search"> 
      	  	<input type="text" 	value="" name="search_pro_typ" class="input-large search-l" id="search_pro_typ" placeholder="Material Name">
          ...
          <table>
            <tbody>
              <tr>
                ...
                <th>Courier Type ID</th>
                <th>Courier Type Code</th>
    ...
    if(!empty($pro_type)) {
     ...
     foreach($pro_type as $PROTYP) { ?>
              <tr>
                ...
                <td ><a href="<?php echo site_url('masters/viewproducttype/'); ?>/<?php echo $PROTYP['products_type_id']; ?>"><?php echo $PROTYP['producttype_id'];?></a></td>
                <td ><a href="<?php echo site_url('masters/viewproducttype/'); ?>/<?php echo $PROTYP['products_type_id']; ?>"><?php echo $PROTYP['product_type_code'];?></a></td>
                ...
                <td ><a href="<?php echo site_url('masters/viewproducttype/'); ?>/<?php echo $PROTYP['products_type_id']; ?>"><?php echo $PROTYP['product_type_stus'];?></a></td>
