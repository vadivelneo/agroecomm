		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Update User</h3>
					<span class="pull-right">
						<button class="btn-success save" value="Save"  type="submit" name="users_add_details" id="users_add_details"><strong>Update</strong></button>
                    ...
                    <tbody>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="first_name" name="first_name" type="text" value="<?php if(isset($usr->user_first_name)){ echo $usr->user_first_name;}?>" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="last_name" name="last_name" value="<?php if(isset($usr->user_last_name)){ echo $usr->user_last_name;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <input id="mob" name="mob" value="<?php if(isset($usr->user_phone)){ echo $usr->user_phone;}?>" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="email" name="email" value="<?php if(isset($usr->user_email)){ echo $usr->user_email;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="username" name="username" value="<?php if(isset($usr->user_name)){ echo $usr->user_name;}?>" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <!--<td class="fieldLabel medium">
                                ...
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <select name="company" class="chzn-select" id="company">
                                            ...
                                            <option <?php if($COM['company_id'] == $usr->user_company_id) { ?> selected="selected" <?php } ?> value="<?php echo $COM['company_id']; ?>"><?php echo $COM['company_short_name']; ?></option>
                                           	<?php } } ?>
                                        </select>
                                    </span>
                                </div>
              ...
              <tbody>
                  ...
                  <td class="fieldValue medium" ><div class="row-fluid"><span class="span10">
                      <textarea class="row-fluid" name="street" id="street" ><?php if(isset($usr->user_address)){ echo $usr->user_address;}?></textarea>
                      </span></div>
                  </td>
                  <td class="fieldLabel medium">
                                <label class="muted pull-right marginRight10px">
                  ...
                  <td class="fieldValue medium">
                      ...
                      <td class="fieldValue medium" ><div class="row-fluid"><span class="span10">
                      <input id="zip_code" name="zip_code" type="text" value="<?php if(isset($usr->user_zipcode)){ echo $usr->user_zipcode;}?>" class="input-large " />
                      </span></div></td>
                        </tr>
              </tbody>
            </table>
