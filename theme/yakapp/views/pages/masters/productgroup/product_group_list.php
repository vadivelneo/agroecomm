  ...
  <div class="rightPanel">
    ...
    <div class="row-fluid">
     <!-- <div tabindex="2" class="wrapper-dropdown-5" id="actions">Actions
      ...
      <button class="addButton" onclick='window.location.href="<?php echo site_url('masters/addproductgroup'); ?>"'><i class="icon-plus" ></i>&nbsp;<strong>Add Material Group</strong></button>
      </span>
