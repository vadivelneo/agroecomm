    ...
    <div class='container-fluid editViewContainer'>
      <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
        <div class="contentHeader row-fluid">
          <h3 class="span8 textOverflowEllipsis">Update Payment Mode</h3>
          <span class="pull-right">
            <button class="btn-success save" value="Save"  type="submit" name="pay_mode_edit_details" id="pay_mode_edit_details"><strong>Update</strong></button>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="pay_mode_name" name="pay_mode_name" value="<?php if(isset($paymentmodedata->payment_mode_name)){ echo $paymentmodedata->payment_mode_name;}?>" type="text" class="input-large nameField" />
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <textarea id="pay_mode_desc" name="pay_mode_desc" type="text" class="input-large nameField" /><?php if(isset($paymentmodedata->payment_mode_description)){ echo $paymentmodedata->payment_mode_description;}?></textarea>
                                    </span>
                                </div>
                            </td>
                        </tr>
