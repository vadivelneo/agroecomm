        ...
        <div class='container-fluid editViewContainer'>
            <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="" enctype="multipart/form-data">
                <div class="contentHeader row-fluid">
                    <h3 class="span8 textOverflowEllipsis">Updating Item Sub Group</h3>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="product_group_name" name="product_group_name" value="<?php if(isset($progroupdata->product_sub_group_name)){ echo $progroupdata->product_sub_group_name;}?>" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    ...
                                    <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="pro_grp_descError" style="margin-top: -30px;">
                                        ...
                                        <textarea id="description" name="description" class="input-large nameField"><?php if(isset($progroupdata->product_sub_group_description)){ echo $progroupdata->product_sub_group_description;}?></textarea>
                                    </span>
                                 </div>
                             </td>
                        </tr>
                                ...
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <select   name="product_group_id" class="chzn-select" id="product_group_id">
                                            ...
                                            <option <?php if($TYPE['products_group_id'] == $progroupdata->product_group_id) { ?> selected="selected" <?php } ?> value="<?php echo $TYPE['products_group_id']; ?>"><?php echo $TYPE['products_group_name']; ?></option>
                                            <?php } } ?>
                                        </select>
