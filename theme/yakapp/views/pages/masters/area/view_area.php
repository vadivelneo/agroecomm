		...
		<div class='container-fluid editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="#" enctype="multipart/form-data">
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">View Area</h3>
                ...
                <table class="table table-bordered blockContainer showInlineTable equalSplit">
                  ...
                  <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="region_nameError" style="margin-top: -30px;">
                      ...
                      <select class="chzn-select assigned_user_id" id="region_name" disabled="disabled" name="region_name" >
                  ...
                  <div class="Products_editView_fieldName_productnameformError parentFormEditView formError" id="zone_nameError" style="margin-top: -30px;">
                      ...
                      <select class="chzn-select assigned_user_id" id="zone_name" disabled="disabled" name="zone_name" >
                        <option value="">Select an Option</option>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($Area->area_name)){ echo $Area->area_name;}?>
                                    </span>
                                 </div>
                             </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                       ...
                                       <?php if(isset($Area->area_code)){ echo $Area->area_code;}?>
                                    </span>
                                </div>
                            </td>
                        </tr>
