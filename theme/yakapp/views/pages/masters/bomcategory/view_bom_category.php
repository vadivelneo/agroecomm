                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($bomtypedata->bom_category_name)){ echo $bomtypedata->bom_category_name;}?>
                                    </span>
                                 </div>
                             </td>
                             <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <?php if(isset($bomtypedata->bom_category_type_name)){ echo $bomtypedata->bom_category_type_name;}?>
                         ...
                         <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
									...
									<?php if(isset($bomtypedata->bom_cat_stat)){ echo $bomtypedata->bom_cat_stat;}?>
