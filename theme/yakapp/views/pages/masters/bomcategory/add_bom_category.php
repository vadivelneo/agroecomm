		...
		<div class='container-fluid editViewContainer'>
            ...
            <br />
				<div class="contentHeader row-fluid">
					<h3 class="span8 textOverflowEllipsis">Creating BOM Category</h3>
					<span class="pull-right">
						<button class="btn-success save" value="Save"  type="submit" name="add_bom_cat_type" id="add_bom_cat_type"><strong>Save</strong></button>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="bom_category_name" name="bom_category_name" type="text" class="input-large nameField" />
                                    </span>
                                 </div>
                             </td>
                             <td class="fieldLabel medium">
                                ...
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <select name="cat_type" class="chzn-select" id="cat_type">
                                            ...
                                            <option value="<?php echo $COM['bom_cat_type_id']; ?>"><?php 
											echo $COM['bom_category_type_name']; ?></option><?php } } ?>
                                        </select>
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input id="prefix" name="prefix" type="radio" value="active" class="input-large nameField">&nbsp;&nbsp;Active &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input id="prefix" name="prefix" type="radio" value="deactive" class="input-large nameField" />&nbsp;&nbsp;Deactive 
                                    </span>
                                </div>
                            </td>
                            <td class="fieldLabel medium">
