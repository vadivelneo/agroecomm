        ...
        <div class="listViewPageDiv">
          <div class="listViewTopMenuDiv noprint">
            <div class="listViewActionsDiv row-fluid"><span class="btn-toolbar span4"><span class="btn-group listViewMassActions">
              ...
              <a href="<?php echo site_url('accounts/new_credit_note'); ?>"><button class="btn addButton" id="Accounts_listView_basicAction_LBL_ADD_RECORD"><i class="icon-plus"></i>&nbsp;<strong>Add Credit Note</strong></button></a>
