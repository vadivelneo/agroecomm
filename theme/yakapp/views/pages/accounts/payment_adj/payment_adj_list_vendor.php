...
<section>
	...
	<div class="rightPanel" style="padding: 14px 20px; width:96%;">
		...
		<div class='container-fluid editViewContainer'>
        			<form class="form-horizontal recordEditView" id="payment_adjustment_form" name="payment_adjustment_form" method="post" action="<?php echo site_url('accounts/add_payment_adjustment_vendor');?>" enctype="multipart/form-data">
					...
					<tbody>
						<tr>
							<!--<td class="fieldLabel medium">
                                <label class="muted pull-right marginRight10px">Receipt Type</label>
                            </td>
                            <td class="fieldValue medium" >
                                <div class="row-fluid">
                                    <span class="span10">
										 ...
										 <select class="chzn-select"  name="pay_adj_type" id="pay_adj_type">
											
											<option value="invoicereceipt">Income Receipt</option>	
							...
							<td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                       ...
                                       <input type="hidden"  name="pay_adj_type" id="pay_adj_type" value="paymentreceipt" />
...
function getstatus(id)
 {
	...
	if(parseFloat(popup_due_amt) <= parseFloat(popup_inv_tds_amt))
					...
					{	
						$('.flashmessage').html("");
						document.getElementById("ErrorMsg").innerHTML="Sorry!!! The Status Can't be Changed";
						var status = 'Pending';
						$("#invoice_status_"+id).val(status);
