 ...
 <?php //echo "<PRE>";print_r($bill);exit;?> 
  ...
  <div id="customer">
    <table width="532" id="meta" style="float:left;">
      <tr>
        <td width="150" class="meta-head">Vendor Name</td>
        <td width="370"><?php echo $ven_det->vendor_name;?></td>
      </tr>
      <tr>
        <td class="meta-head">Address</td>
        <td><address>
          <?php echo $bill->vendor_address	;?>,<br>
          <?php echo $bill->city_name;?>,<?php echo $bill->state_name;?>,<br>
          <?php echo $bill->country_name;?>-<?php echo $bill->venor_zipcode;?>
          </address></td>
      </tr>
      <tr>
        <td class="meta-head">Email</td>
        <td><?php echo $ven_det->vendor_email;?></td>
      </tr>
      <tr>
        <td class="meta-head">Mobile </td>
        <td><?php echo $ven_det->vendor_phone;?></td>
      </tr>
    </table>
  ...
  <table class="">
    ...
    <tbody>
      <tr>
        <td width="133" class="blockHeader"><label class="muted pull-right marginRight10px">Payment Receipt No </label></td>
        <td width="232" ><?php echo $editpay_recp->payment_receipt_number;?></td>
        <td width="140" class="blockHeader"><label class="muted pull-right marginRight10px"> Receipt Date </label></td>
        <td width="275" ><?php echo $editpay_recp->payment_receipt_date;?></td>
      </tr>
      <tr>
        <td class="blockHeader"><label class="muted pull-right marginRight10px">Vendor Name </label></td>
        <td class=""><?php echo $editpay_recp->vendor_name;?></td>
        <td class="blockHeader"><label class="muted pull-right marginRight10px">Vendor Code</label></td>
        <td ><?php echo $editpay_recp->vendor_code;?></td>
      </tr>
      <tr>
        <td class="blockHeader"><label class="muted pull-right marginRight10px">Amount</label></td>
        <td><?php echo $editpay_recp->payment_receipt_amount;?></td>
        <td class="blockHeader"><label class="muted pull-right marginRight10px">Status</label></td>
        <td><?php echo $editpay_recp->payment_receipt_status;?></td>
      </tr>
      <tr>
        <td class="blockHeader"><label class="muted pull-right marginRight10px"> Description </label></td>
        <td  colspan="3"><?php echo $editpay_recp->payment_receipt_descrption;?></td>
      </tr>
    </tbody>
  </table>
  <p>&nbsp;</p>
