<?php //echo"<PRE>"; print_r($credit_details);exit;?>
          ...
          <table>
            <tbody>
              <tr>
                ...
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Sales Return Invoive&nbsp;&nbsp;</a></th>
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Invoice No&nbsp;&nbsp;</a></th>
                <th nowrap><a href="javascript:void(0);" class="listViewHeaderValues">Return Amount  &nbsp;&nbsp;</a></th>
		...
		if(!empty($credit_details)) {
		 ...
		 foreach($credit_details as $Cus) { ?>
              <tr class="listViewEntries" data-id='36'  id="Leads_listView_row_1">
                <td><?php echo $Cus['sales_return_code'];?></a></td>
                <td><?php echo $Cus['sale_invoice_company_invoice_no'];?></a></td>
                <td><?php echo $Cus['sales_return_total_net_amount'];?></td>
