<script type="text/javascript">
		function accordin_grid($id,$i)
		{
				...
				var search_id = $id;
				   ...
				   $.ajax({
					type: 'POST',
					url: '<?php echo site_url('deliverychallan/view_deliverychallan_summary'); ?>',
...
<section>
  ...
  <div class="rightPanel">
    ...
    <div class="row-fluid">
       ...
       <form class="form-horizontal " id="stockForm" name="stockForm" method="post" action="<?php echo site_url('reports/dc_search'); ?>" enctype="multipart/form-data"> 
      ...
      <div class="col w10 last summary_child">
	  	<div class="sessionMsg"><?php echo $this->session->flashdata('message'); ?></div>
            ...
            <div style="width:100%;font-weight:bold;">
                    ...
                    <div class="summary_div_pur">DC Date
                    </div>
                    <div class="summary_div_child" style="width:10%;">DC No
                    </div>
                    <div class="summary_div_pur">So No
                    </div>
                   
                    <div class="summary_div_pur">Customer Name
                    </div>
                    <div class="summary_div_child" style="width:15%;" >Sales Rep.
                    </div>
					...
					<div >
                    <span id="accordin_grid_<?php echo $i; ?>" class="summary_child_cont1" style="display:block" onclick="accordin_grid('<?php echo $DC['delivery_challan_id']; ?>','<?php echo $i; ?>')">
                    <img src="<?php echo base_url();?>resources/images/add-icon.png" class="summary_child_img">
                    </span><span id="accordin_close_grid_<?php echo $i; ?>" class="summary_child_cont1" style="display:none" onclick="accordin_close_grid('<?php echo $DC['delivery_challan_id']; ?>','<?php echo $i; ?>')">
                    ...
                    <div class="summary_div_child" style="width:10%;"><a href="javascript:void(0)" onclick="accordin_grid('<?php echo $DC['delivery_challan_id']; ?>','<?php echo $i; ?>')">
											<?php echo $DC['delivery_challan_number'];?>
										</a>
                    </div>
                    <div class="summary_div_pur"><a href="javascript:void(0)" onclick="accordin_grid('<?php echo $DC['delivery_challan_id']; ?>','<?php echo $i; ?>')">
											<?php echo ucfirst($DC['delivery_challan_sales_reference_number']);?>
										</a>
                    </div>
                    
                    <div class="summary_div_pur"><a href="javascript:void(0)" onclick="accordin_grid('<?php echo $DC['delivery_challan_id']; ?>','<?php echo $i; ?>')">
											<?php echo $DC['customer_name'];?>
										</a>
                    </div>
                    <div class="summary_div_child" style="width:15%;"><a href="javascript:void(0)" onclick="accordin_grid('<?php echo $DC['delivery_challan_id']; ?>','<?php echo $i; ?>')">
											<?php echo $DC['designation_user_name'];?>
										</a>
                    </div>
                    <div class="summary_div_pur"><a href="javascript:void(0)" onclick="accordin_grid('<?php echo $DC['delivery_challan_id']; ?>','<?php echo $i; ?>')">
											<?php echo $DC['delivery_challan_status'];?>
										</a>
                    </div>
