...
<section>
  <div class="rightPanel">
   ...
   <div class="sessionMsg" id="ErrorMsg"><?php echo $this->session->flashdata('message'); ?></div>	
        ...
        <form class="form-horizontal " id="stockForm" name="stockForm" method="post" action="<?php echo site_url('reports/item_wise_general_report'); ?>" enctype="multipart/form-data"> 
