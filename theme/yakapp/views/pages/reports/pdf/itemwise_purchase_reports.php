...
<table cellspacing="0" cellpadding="0" border="1" width="100%" >
  <tr>
    ...
    <div align="center"><strong><?php if(isset($itm_name)){ echo $itm_name; }?>  Purchase Report</strong></div></td>
  </tr>
  <tr>
  ...
  <tr bgcolor="#CCCCCC">
    ...
    <td width="20%"><div align="left">Type</div></td>
     <td width="20%"><div align="left">Amount</div></td>
   </tr>
    <?php
	foreach($list_items as $ITEM) {?>
  <tr>
    <td><div align="left"><?php echo $ITEM['po_invoice_items_code'];?></div></td>
          <td><div align="left"><?php echo $ITEM['uom_name'];?></div></td>
       <td><div align="left"><?php echo $ITEM['po_invoice_number'];?></div></td>
       <td><div align="left"><?php echo $ITEM['vendor_name'];?></div></td>
       <td><div align="left"><?php echo $ITEM['po_invoice_items_qty'];?></div></td>
       <td><div align="left"><?php if(($ITEM['po_invoice_stk_Inv_po_id']) == 0) { echo "PI"; } else{ echo "DC";} ?></div></td>
       <td><div align="right"><?php echo $ITEM['po_invoice_items_net_amount'];?></div></td>
     </tr>
  <?php }?>
</table>
<div class="footer">
