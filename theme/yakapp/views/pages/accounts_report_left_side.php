    ...
    <div class="leftPanel">
        <div class="row-fluid">
            <div class="quickLinksDiv">
            	...
            	<h1 class="rep_new"> Accounts Reports</h1>
            	<p class="<?php if(in_array($uri_segment_two, $income_receipt_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="<?php echo site_url('reports/invoice_recp_list'); ?>" class="quickLinks"><strong>Income Receipt</strong></a>
                </p>
            	<p class="<?php if(in_array($uri_segment_two, $payment_receipt_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="<?php echo site_url('reports/payment_recp_list'); ?>" class="quickLinks"><strong>Payment Receipt</strong></a>
                </p> 
                <p class="<?php if(in_array($uri_segment_two, $customer_debit_note_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="<?php echo site_url('reports/customer_debit_note'); ?>" class="quickLinks"><strong>Customer Debit Note</strong></a>
                </p> 
                 <p class="<?php if(in_array($uri_segment_two, $customer_credit_note_uri)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="<?php echo site_url('reports/customer_credit_note'); ?>" class="quickLinks"><strong>Customer Credit Note</strong></a>
                </p> 
            	
             				
				<p class="<?php if(in_array($uri_segment_two, $customer_credit_note_uri1)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="#" class="quickLinks"><strong>Account Statement</strong></a>
                </p> 
				
				<p class="<?php if(in_array($uri_segment_two, $customer_credit_note_uri1)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="#" class="quickLinks"><strong>Outstanding Report</strong></a>
                </p> 
				
				<p class="<?php if(in_array($uri_segment_two, $customer_credit_note_uri1)) { echo 'selectedQuickLink'; } else { echo "unSelectedQuickLink"; } ?>">
                	<a href="#" class="quickLinks"><strong>Daily Expenses</strong></a>
                </p>
