<table id="tblList">
          ...
          <?php if(!empty($editpurchaseorder_items)) { $itemcount = 1; foreach($editpurchaseorder_items as $ITEMS) { ?>
                        <tr>
                            <td>
                            <?php if($ITEMS['product_mfr_part_number']!= '') { echo $ITEMS['product_mfr_part_number']; } else { echo '-'; } ?>
                           ...
                           <?php if(isset($ITEMS['po_items_qty'])) { echo $ITEMS['po_items_qty'];  } ?> 
                            <input name="items_ord_qty[<?php echo $itemcount; ?>]" type="hidden"  value="<?php if(isset($ITEMS['po_items_qty'])) { echo $ITEMS['po_items_qty']; } ?>" class="quantity" />
                            </td>
