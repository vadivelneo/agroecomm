...
function onchangegetitemspopup()
 {	
	...
	var search_product_group = $('select#search_product_group').val();
	 	...
	 	$.ajax({
 		type: 'POST',
 		url: '<?php echo site_url('inventory/onchangegetitemspopup'); ?>',
							...
							<td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input type="text" value="" name="cur_qty" class="input-large numonly" id="cur_qty" onkeyup="return onkeyupfortotal_calc()">
                                    </span>
                                 </div>
                             </td>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        ...
                                        <input type="text" value="" readonly="readonly" name="adj_qty" class="input-large numonly" id="adj_qty">
                                    </span>
                                 </div>
                             </td>
...
<script type="text/javascript">
function onkeyupfortotal_calc()
{
	//alert ("hai");return false;
    var curr_qty = $("#cur_qty").val();
    var inv_qty = $("#item_qty").val();
    var adj_qty = $("#adj_qty").val();
