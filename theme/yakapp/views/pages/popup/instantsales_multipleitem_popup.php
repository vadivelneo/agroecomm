		   ...
		   var customer_tax_type = $("#customer_tax_type").val();
			...
			if(tax_value != 'nontaxable')
			{
				for (var i in json_obj) 
				{
					...
					output+='<input id="multiple_item_mfg_prtno_' + itemcount + '" name="multiple_item_mfg_prtno[' + itemcount + ']" value="" type="hidden" />';
					output+='</td>';
					...
					output+='<td>';
					output+='<li>' + json_obj[i].division_name + '</li>';
					output+='<input id="multiple_item_division_id_' + itemcount + '" name="multiple_item_division_id[' + itemcount + ']" value="' + json_obj[i].division_id + '" type="hidden" />';
					output+='<input id="multiple_item_division_name_' + itemcount + '" name="multiple_item_division_name[' + itemcount + ']" value="' + json_obj[i].division_name + '" type="hidden" />';
					output+='</td>';
					
					
					output+='<td>';
					output+='<li>' + json_obj[i].store_name + '</li>';
					output+='<input id="multiple_item_store_id_' + itemcount + '" name="multiple_item_store_id[' + itemcount + ']" value="' + json_obj[i].store_id + '" type="hidden" />';
					output+='<input id="multiple_item_store_name_' + itemcount + '" name="multiple_item_store_name[' + itemcount + ']" value="' + json_obj[i].store_name + '" type="hidden" />';
					output+='</td>';
					
					output+='<td>';
					output+='<li>' + json_obj[i].price_book_price_hsn + '</li>';
					...
					output+='  <input id="multiple_item_qty_' + itemcount + '" class="quantity stock_text" name="multiple_item_qty[' + itemcount + ']" onkeyup="return salse_multiplepopuptotal(event, ' + itemcount + ')"  type="text" value="0"  type="text" readonly="readonly" />';
					output+='</td>';
			...
			if(this.checked == true)
			{
					...
					else
					{
						...
						if(jQuery.inArray(popup_item_id,old_items)==-1)	
						{
							...
							if(tax_value != 'nontaxable')
							{
							  var items ='<tr><td><a href="javascript:void(0);" >'+counter+'</a><input id="multiple_item_product_code_'+counter+'" name="multiple_item_product_code['+counter+']" value="'+popup_item_product_code+'" type="hidden" /><input id="item_mfg_prtno_'+counter+'" name="item_mfg_prtno['+counter+']" value="'+popup_item_mfg_prtno+'" type="hidden" /><input id="item_code_'+counter+'" name="item_code['+counter+']" value="'+popup_item_code+'" type="hidden" /><input id="item_id_'+counter+'" name="item_id['+counter+']" value="'+popup_item_id+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_name_value_'+counter+'">'+popup_item_name+'</a><input id="item_name_'+counter+'" name="item_name['+counter+']" value="'+popup_item_name+'" type="hidden" /><input id="multiple_item_division_id_'+counter+'" name="multiple_item_division_id['+counter+']" value="'+popup_item_division_id+'" type="hidden" /><input id="multiple_item_division_name_'+counter+'" name="multiple_item_division_name['+counter+']" value="'+popup_item_division_name+'" type="hidden" /><input id="multiple_item_store_id_'+counter+'" name="multiple_item_store_id['+counter+']" value="'+popup_item_store_id+'" type="hidden" /><input id="multiple_item_store_name_'+counter+'" name="multiple_item_store_name['+counter+']" value="'+popup_item_store_name+'" type="hidden" /></td><td><a href="javascript:void(0);">'+popup_item_hsn+'</a><input id="item_hsn_value_'+counter+'" name="item_hsn_value['+counter+']" value="'+popup_item_hsn+'" type="hidden" /></td><td><input id="item_qty_'+counter+'"  class="quantity stock_text" name="item_qty['+counter+']" value="'+popup_item_qty+'" type="text"  onkeyup="return sales_items_grid_total(event, '+counter+')" /><input id="free_qty_name'+counter+'" class="quantity " name="free_qty_name['+counter+']" value="-" type="hidden" readonly="readonly" /><input id="item_qty_free_'+counter+'" class="quantity stock_text" name="item_qty_free['+counter+']" value="'+popup_item_qty+'" type="hidden" readonly="readonly" /></td><td><input id="item_uom_id_'+counter+'" name="item_uom_id['+counter+']" type="hidden" value="'+popup_item_uom_id+'" /><input id="item_uom_name_'+counter+'" name="item_uom_name['+counter+']" type="hidden" value="'+popup_item_uom_name+'" /><input id="item_mrp_'+counter+'" name="item_mrp['+counter+']" readonly="readonly" type="text" class="quantity " value="'+popup_item_mrp+'" /></td><td><input id="item_priceperunit_'+counter+'" name="item_priceperunit['+counter+']" value="'+popup_item_priceperunit+'" type="text" readonly="readonly" class="quantity" onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_gross_amount_'+counter+'" name="item_gross_amount['+counter+']" value="'+popup_gross_amount+'" type="text" class="quantity stock_text" readonly="readonly" /><input id="item_discount_percent_'+counter+'" name="item_discount_percent['+counter+']" value="'+popup_item_discount_percent+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_discount_amount_'+counter+'" name="item_discount_amount['+counter+']" value="'+popup_item_discount_amount+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_damage_discount_percentage_'+counter+'" name="item_damage_discount_percentage['+counter+']" value="'+popup_item_damage_discount_percent+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_damage_discount_amount_'+counter+'" name="item_damage_discount_amount['+counter+']" value="'+popup_item_damage_discount_amount+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_gross_amount_with_disc_'+counter+'" name="item_gross_amount_with_disc['+counter+']" value="" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_net_amount_'+counter+'" name="item_net_amount['+counter+']" value="'+item_net_amount+'" type="hidden" class="quantity" readonly="readonly" /></td><td><input id="item_tax_percent_'+counter+'" name="item_tax_percent['+counter+']" value="'+item_tax_percent+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_cgst_'+counter+'" name="item_cgst['+counter+']" value="'+popup_item_gst+'" type="text"  class="quantity stock_text" readonly="readonly" /><input id="item_tax_amount_'+counter+'" name="item_tax_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_cgst_amount_'+counter+'" name="item_cgst_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /></td><td><input id="item_sgst_'+counter+'" name="item_sgst['+counter+']" value="'+popup_item_sgst+'" type="text" readonly="readonly" class="quantity stock_text"  /><input id="item_sgst_amount_'+counter+'" name="item_sgst_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /></td><td><input id="item_igst_'+counter+'" name="item_igst['+counter+']" value="'+popup_item_igst+'" type="text" readonly="readonly" class="quantity stock_text"  /><input id="item_igst_amount_'+counter+'" name="item_igst_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /></td><td colspan="2"><div class="itemsgrid_action itemsgrid_delete" id="itemsgrid_delete_'+counter+'" onclick="return itemsgridrowdelete('+counter+');" data-item="'+popup_item_id+'" data-delete="'+counter+'" title="Delete"><span class="icon-trash"></span></div></td></tr>';
							}
							else
							{
							 var items ='<tr><td><a href="javascript:void(0);" >'+counter+'</a><input id="multiple_item_product_code_'+counter+'" name="multiple_item_product_code['+counter+']" value="'+popup_item_product_code+'" type="hidden" /><input id="item_mfg_prtno_'+counter+'" name="item_mfg_prtno['+counter+']" value="'+popup_item_mfg_prtno+'" type="hidden" /><input id="item_code_'+counter+'" name="item_code['+counter+']" value="'+popup_item_code+'" type="hidden" /><input id="item_id_'+counter+'" name="item_id['+counter+']" value="'+popup_item_id+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_name_value_'+counter+'">'+popup_item_name+'</a><input id="item_name_'+counter+'" name="item_name['+counter+']" value="'+popup_item_name+'" type="hidden" /><input id="multiple_item_division_id_'+counter+'" name="multiple_item_division_id['+counter+']" value="'+popup_item_division_id+'" type="hidden" /><input id="multiple_item_division_name_'+counter+'" name="multiple_item_division_name['+counter+']" value="'+popup_item_division_name+'" type="hidden" /><input id="multiple_item_store_id_'+counter+'" name="multiple_item_store_id['+counter+']" value="'+popup_item_store_id+'" type="hidden" /><input id="multiple_item_store_name_'+counter+'" name="multiple_item_store_name['+counter+']" value="'+popup_item_store_name+'" type="hidden" /></td><td><a href="javascript:void(0);">'+popup_item_hsn+'</a><input id="item_hsn_value_'+counter+'" name="item_hsn_value['+counter+']" value="'+popup_item_hsn+'" type="hidden" /></td><td><a href="javascript:void(0);"></a><input id="item_batch_no_'+counter+'" name="item_batch_no['+counter+']" class="quantity stock_text" value="" type="text" /></td><td><a href="javascript:void(0);"></a><input id="item_expiry_date_'+counter+'" name="item_expiry_date['+counter+']" class="quantity stock_text" value="" type="text" /></td><td><input id="item_qty1_'+counter+'" class="qty_pack_size" name="item_qty1['+counter+']" type="text" onkeyup="pack_size_calc('+counter+')" placeholder="Size" /><input id="item_qty2_'+counter+'" class="qty_pack_size" name="item_qty2['+counter+']" type="text" onkeyup="pack_size_calc('+counter+')" placeholder="Size" /><input id="item_qty3_'+counter+'" class="qty_pack_size" name="item_qty3['+counter+']" type="text" onkeyup="pack_size_calc('+counter+')" placeholder="Size"/><input id="item_qty4_'+counter+'" class="qty_pack_size" name="item_qty4['+counter+']" type="text" onkeyup="pack_size_calc('+counter+')" placeholder="Size"/><input id="item_actual_qty_'+counter+'" class="qty_pack_size" name="item_actual_qty['+counter+']" placeholder="Qty" type="text" onkeyup="pack_size_calc('+counter+')" /></td><td><input id="item_qty_'+counter+'"  class="quantity stock_text" name="item_qty['+counter+']" value="'+popup_item_qty+'" type="text" readonly="readonly" onkeyup="return sales_items_grid_total(event, '+counter+')" /><input id="free_qty_name'+counter+'" class="quantity " name="free_qty_name['+counter+']" value="-" type="hidden" readonly="readonly" /><input id="item_qty_free_'+counter+'" class="quantity stock_text" name="item_qty_free['+counter+']" value="'+popup_item_qty+'" type="hidden" readonly="readonly" /></td><td><input id="item_uom_id_'+counter+'" name="item_uom_id['+counter+']" type="hidden" value="'+popup_item_uom_id+'" /><input id="item_uom_name_'+counter+'" name="item_uom_name['+counter+']" type="hidden" value="'+popup_item_uom_name+'" /><input id="item_mrp_'+counter+'" name="item_mrp['+counter+']" readonly="readonly" type="text" class="quantity " value="'+popup_item_mrp+'" /></td><td><input id="item_priceperunit_'+counter+'" name="item_priceperunit['+counter+']" value="'+popup_item_priceperunit+'" type="text" readonly="readonly" class="quantity" onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_gross_amount_'+counter+'" name="item_gross_amount['+counter+']" value="'+popup_gross_amount+'" type="text" class="quantity stock_text" readonly="readonly" /><input id="item_discount_percent_'+counter+'" name="item_discount_percent['+counter+']" value="'+popup_item_discount_percent+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_discount_amount_'+counter+'" name="item_discount_amount['+counter+']" value="'+popup_item_discount_amount+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_damage_discount_percentage_'+counter+'" name="item_damage_discount_percentage['+counter+']" value="'+popup_item_damage_discount_percent+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_damage_discount_amount_'+counter+'" name="item_damage_discount_amount['+counter+']" value="'+popup_item_damage_discount_amount+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_gross_amount_with_disc_'+counter+'" name="item_gross_amount_with_disc['+counter+']" value="" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_net_amount_'+counter+'" name="item_net_amount['+counter+']" value="'+item_net_amount+'" type="hidden" class="quantity" readonly="readonly" /></td><td><input id="item_tax_percent_'+counter+'" name="item_tax_percent['+counter+']" value="'+item_tax_percent+'" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_cgst_'+counter+'" name="item_cgst['+counter+']" value="'+popup_item_gst+'" type="text"  class="quantity stock_text" readonly="readonly" /><input id="item_tax_amount_'+counter+'" name="item_tax_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /><input id="item_cgst_amount_'+counter+'" name="item_cgst_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /></td><td><input id="item_sgst_'+counter+'" name="item_sgst['+counter+']" value="'+popup_item_sgst+'" type="text" readonly="readonly" class="quantity stock_text"  /><input id="item_sgst_amount_'+counter+'" name="item_sgst_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /></td><td><input id="item_igst_'+counter+'" name="item_igst['+counter+']" value="'+popup_item_igst+'" type="text" readonly="readonly" class="quantity stock_text"  /><input id="item_igst_amount_'+counter+'" name="item_igst_amount['+counter+']" value="0" type="hidden" class="quantity stock_text" readonly="readonly" /></td><td colspan="2"><div class="itemsgrid_action itemsgrid_delete" id="itemsgrid_delete_'+counter+'" onclick="return itemsgridrowdelete('+counter+');" data-item="'+popup_item_id+'" data-delete="'+counter+'" title="Delete"><span class="icon-trash"></span></div></td></tr>';			
								}
        ...
        <div class="content">
          <table>
            ...
            <tbody id="multiple_items">
              ...
              <input id="multiple_item_product_code_<?php echo $itemcount; ?>" name="multiple_item_product_code[<?php echo $itemcount; ?>]" value="<?php if(isset($PROLST['product_code'])) { echo $PROLST['product_code']; } ?>" type="hidden" />
              </td>
              ...
              <input id="multiple_item_name_<?php echo $itemcount; ?>" name="multiple_item_name[<?php echo $itemcount; ?>]" value="<?php if(isset($PROLST['product_name'])) { echo $PROLST['product_name']; } ?>" type="hidden" />
               ...
               <td>
					<input id="multiple_item_hsn_<?php echo $itemcount; ?>" class="quantity stock_text" name="multiple_item_hsn[<?php echo $itemcount; ?>]" type="text" value="<?php if(isset($PROLST['price_book_price_hsn'])) { echo $PROLST['price_book_price_hsn']; } ?>" readonly="readonly" />
					</td>
              <td>
              ...
              <input id="multiple_item_qty_<?php echo $itemcount; ?>" onkeyup="return salse_multiplepopuptotal(event, <?php echo $itemcount; ?>)" class="quantity stock_text" name="multiple_item_qty[<?php echo $itemcount; ?>]" type="text" readonly="readonly" value="0" />
			  </td>
               <td>
