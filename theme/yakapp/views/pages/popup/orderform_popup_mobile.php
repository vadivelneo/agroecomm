		   ...
		   var customer_tax_type = $("#customer_tax_type").val();
			...
			if(tax_value != 'nontaxable')
			{
				for (var i in json_obj) 
				{
					...
					output+='<td ><input type="checkbox" class="itemcheckbox" id="checkbox' + itemcount + '" value="' + itemcount + '" name="item_check[]">';
					output+='</td>';
					
					
					output+='<td>';
					output+='<li>' + json_obj[i].product_sku.substr(0,60) + '</li>';
					...
					output+='  <input id="multiple_item_priceperunit_' + itemcount + '" class="quantity" name="multiple_item_priceperunit[]" type="hidden" value="' + json_obj[i].price_book_price_selling_price + '" readonly="readonly" />';
					...
					output+='  <input id="multiple_item_rate_' + itemcount + '" class="quantity" name="multiple_item_rate[' + itemcount + ']" value="" type="hidden" readonly="readonly"  />';
					output+='</td>';
					output+='</tr>';
      ...
      <table>
      	<tr>
			...
			<td>
				...
				<input type="hidden" 	value="" name="search_multiple_item_mfg_prtno" autocomplete="off" class="input-large" id="search_multiple_item_mfg_prtno" onkeyup="search_multiple_product()">
				</select>
                <span id="auto_complete_item_name"></span>
            </td>
			<td>
      ...
      <form id="multiple_item_form">
        <div class="content">
          <table>
            <thead>
              <tr>
              	<th ><input type="checkbox" id="multipleItemselecctall" value=""></th>
            ...
            <tbody id="multiple_items">
			  ...
			  ?>
              <tr>
              <td ><input type="checkbox" class="itemcheckbox" id="checkbox<?php echo $itemcount; ?>" value="<?php echo $itemcount; ?>" name="item_check[]"></td>
              
              
             
              <td>
			  <?php if(isset($PROLST['product_sku'])) { echo substr($PROLST['product_sku'], 0, 30); } ?>
			...
			<input id="multiple_incentive_total_<?php echo $itemcount; ?>" name="multiple_incentive_total[<?php echo $itemcount; ?>]" value="" type="hidden" class="quantity stock_text" onkeyup="return sales_items_grid_total(event, '<?php echo $itemcount; ?>')" />
              ...
              <input id="multiple_item_priceperunit_<?php echo $itemcount; ?>" class="quantity" name="multiple_item_priceperunit[<?php echo $itemcount; ?>]" type="hidden" value="<?php if(isset($PROLST['price_book_price_selling_price'])) { echo $PROLST['price_book_price_selling_price']; } ?>" readonly="readonly" />
              ...
              <input id="multiple_item_rate_<?php echo $itemcount; ?>" class="quantity" name="multiple_item_rate[<?php echo $itemcount; ?>]" readonly="readonly" type="hidden" value="" />
              </td>
              </tr>
              <?php $itemcount++; } } } ?>
            </tbody>
