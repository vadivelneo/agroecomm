...
$(document).ready(function () {
	...
	$('#btnSave').click(function ()
	{
		...
		var	popup_item_inv_id = $("#popup_item_inv_id").val();
		...
		if(jQuery.inArray(popup_item_id, myarray)==-1)
		{
			...
			{
			  var items ='<tr><td><a href="javascript:void(0);" id="item_code_value_'+counter+'">'+popup_item_code+'</a><input id="item_code_'+counter+'" name="item_code['+counter+']" value="'+popup_item_code+'" type="hidden" /><input id="item_id_'+counter+'" name="item_id['+counter+']" value="'+popup_item_id+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_mfg_prtno_value_'+counter+'">'+popup_item_mfg_prtno+'</a><input id="item_mfg_prtno_'+counter+'" name="item_mfg_prtno['+counter+']" value="'+popup_item_mfg_prtno+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_name_value_'+counter+'">'+popup_item_name+'</a><input id="item_name_'+counter+'" name="item_name['+counter+']" value="'+popup_item_name+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_uom_name_value_'+counter+'">'+popup_item_uom_name+'</a><input id="item_uom_id_'+counter+'" name="item_uom_id['+counter+']" type="hidden" value="'+popup_item_uom_id+'" /><input id="item_uom_name_'+counter+'" name="item_uom_name['+counter+']" type="hidden" value="'+popup_item_uom_name+'" /></td><td><input id="item_priceperunit_'+counter+'" name="item_priceperunit['+counter+']" value="'+popup_item_priceperunit+'" type="text" class="quantity" onkeyup="return instantsales_items_grid_total(event, '+counter+')" /></td><td><input id="item_inv_id_'+counter+'" name="item_inv_id['+counter+']" type="hidden" value="'+popup_item_inv_id+'" /><input id="item_inv_qty_'+counter+'" name="item_inv_qty['+counter+']" type="hidden" value="'+popup_item_inv_qty+'" /><input id="item_qty_'+counter+'" class="quantity stock_text" name="item_qty['+counter+']" value="'+popup_item_qty+'" type="text" onkeyup="return instantsales_items_grid_total(event, '+counter+')" /></td><td><input id="item_discount_percent_'+counter+'" name="item_discount_percent['+counter+']" value="'+popup_item_discount_percent+'" type="text" class="quantity stock_text" readonly="readonly" /></td> <td><input id="item_flat_discount_'+counter+'" name="item_flat_discount['+counter+']" value="'+popup_item_flat_discount+'" type="text" class="quantity stock_text"  onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_discount_amount_'+counter+'" name="item_discount_amount['+counter+']" value="'+popup_item_discount_amount+'" type="text" class="quantity stock_text" readonly="readonly" /></td><td><input id="item_tax_percent_'+counter+'" name="item_tax_percent['+counter+']" value="'+item_tax_percent+'" type="text" class="quantity stock_text" readonly="readonly" /><input id="item_vat_'+counter+'" name="item_vat['+counter+']" value="'+popup_item_vat+'" type="hidden" /><input id="item_gst_'+counter+'" name="item_gst['+counter+']" value="'+popup_item_gst+'" type="hidden" /><input id="item_cst_'+counter+'" name="item_cst['+counter+']" value="'+popup_item_cst+'" type="hidden" /><input id="item_serv_tax_'+counter+'" name="item_serv_tax['+counter+']" value="'+popup_item_serv_tax+'" type="hidden" /><input id="item_exc_'+counter+'" name="item_exc['+counter+']" value="'+popup_item_exc+'" type="hidden" /></td><td><input id="item_tax_amount_'+counter+'" name="item_tax_amount['+counter+']" value="'+item_tax_amount+'" type="text" class="quantity stock_text" readonly="readonly" /></td><td><input id="item_gross_amount_'+counter+'" name="item_gross_amount['+counter+']" value="'+popup_gross_amount+'" type="text" class="quantity stock_text" readonly="readonly" /><input id="item_net_amount_'+counter+'" name="item_net_amount['+counter+']" value="'+item_net_amount+'" type="hidden" class="quantity" readonly="readonly" /></td><td colspan="2"><div class="itemsgrid_action itemsgrid_delete" id="itemsgrid_delete_'+counter+'" onclick="return instantitemsgridrowdelete('+counter+');" data-item="'+popup_item_id+'" data-delete="'+counter+'" title="Delete"><span class="icon-trash"></span></div></td></tr>';
			}
			else
			{
				var items ='<tr><td><a href="javascript:void(0);" id="item_code_value_'+counter+'">'+popup_item_code+'</a><input id="item_code_'+counter+'" name="item_code['+counter+']" value="'+popup_item_code+'" type="hidden" /><input id="item_id_'+counter+'" name="item_id['+counter+']" value="'+popup_item_id+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_mfg_prtno_value_'+counter+'">'+popup_item_mfg_prtno+'</a><input id="item_mfg_prtno_'+counter+'" name="item_mfg_prtno['+counter+']" value="'+popup_item_mfg_prtno+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_name_value_'+counter+'">'+popup_item_name+'</a><input id="item_name_'+counter+'" name="item_name['+counter+']" value="'+popup_item_name+'" type="hidden" /></td><td><a href="javascript:void(0);" id="item_uom_name_value_'+counter+'">'+popup_item_uom_name+'</a><input id="item_uom_id_'+counter+'" name="item_uom_id['+counter+']" type="hidden" value="'+popup_item_uom_id+'" /><input id="item_uom_name_'+counter+'" name="item_uom_name['+counter+']" type="hidden" value="'+popup_item_uom_name+'" /></td><td><input id="item_priceperunit_'+counter+'" name="item_priceperunit['+counter+']" value="'+popup_item_priceperunit+'" type="text" class="quantity" onkeyup="return instantsales_items_grid_total(event, '+counter+')" /></td><td><input id="item_inv_id_'+counter+'" name="item_inv_id['+counter+']" type="hidden" value="'+popup_item_inv_id+'" /><input id="item_inv_qty_'+counter+'" name="item_inv_qty['+counter+']" type="hidden" value="'+popup_item_inv_qty+'" /><input id="item_qty_'+counter+'" class="quantity stock_text" name="item_qty['+counter+']" value="'+popup_item_qty+'" type="text" onkeyup="return instantsales_items_grid_total(event, '+counter+')" /><input id="item_tax_percent_'+counter+'" name="item_tax_percent['+counter+']" value="'+item_tax_percent+'" type="hidden" /><input id="item_vat_'+counter+'" name="item_vat['+counter+']" value="'+popup_item_vat+'" type="hidden" /><input id="item_gst_'+counter+'" name="item_gst['+counter+']" value="'+popup_item_gst+'" type="hidden" /><input id="item_cst_'+counter+'" name="item_cst['+counter+']" value="'+popup_item_cst+'" type="hidden" /><input id="item_serv_tax_'+counter+'" name="item_serv_tax['+counter+']" value="'+popup_item_serv_tax+'" type="hidden" /><input id="item_exc_'+counter+'" name="item_exc['+counter+']" value="'+popup_item_exc+'" type="hidden" /><input id="item_tax_amount_'+counter+'" name="item_tax_amount['+counter+']" value="'+item_tax_amount+'" type="hidden" /></td><td><input id="item_discount_percent_'+counter+'" name="item_discount_percent['+counter+']" value="'+popup_item_discount_percent+'" type="text" class="quantity stock_text" readonly="readonly" /></td> <td><input id="item_flat_discount_'+counter+'" name="item_flat_discount['+counter+']" value="'+popup_item_flat_discount+'" type="text" class="quantity stock_text"  onkeyup="return sales_items_grid_total(event, '+counter+')" /></td><td><input id="item_discount_amount_'+counter+'" name="item_discount_amount['+counter+']" value="'+popup_item_discount_amount+'" type="text" class="quantity stock_text" readonly="readonly" /></td><td><input id="item_gross_amount_'+counter+'" name="item_gross_amount['+counter+']" value="'+popup_gross_amount+'" type="text" class="quantity" readonly="readonly" /><input id="item_net_amount_'+counter+'" name="item_net_amount['+counter+']" value="'+item_net_amount+'" type="hidden" class="quantity" readonly="readonly" /></td><td colspan="2"><div class="itemsgrid_action itemsgrid_delete" id="itemsgrid_delete_'+counter+'" onclick="return instantitemsgridrowdelete('+counter+');" data-item="'+popup_item_id+'" data-delete="'+counter+'" title="Delete"><span class="icon-trash"></span></div></td></tr>';
			}
	...
	if(popup_item_id != "")
	{
		...
		$.ajax({
			...
			success: function(resp) 
			{
				...
				var inventory_item_id = myData.inventory_item_id;
				var inventory_qty = myData.inventory_qty;
				...
				$("#popup_item_inv_qty").val(inventory_qty);
				$("#popup_item_inv_id").val(inventory_item_id);
...
<form class="item_popup_blank" id="single_item_popup_form">
	 <a class="close"><img src="<?php echo base_url(); ?>/resources/images/close-button.png" width="25" /></a>
	  ...
	  <span class="singleitem_popup_error nums_error" id="singleitem_inv_error">Out Of Stock</span>
                ...
                <td class="fieldValue medium">
                    <div class="row-fluid">
                        <span class="span10">
                            ...
                            <input type="text" value="" id="popup_item_flat_discount" name="popup_item_flat_discount" class="input-large numeric" onkeyup="return instantsales_popup_onkeyupfortotal(event)">
                        </span>
                     </div>
                </td>
			</tr>
                ...
                <td class="fieldValue medium">
                    <div class="row-fluid">
                        <span class="span10">
                            ...
                            <input type="hidden" value="" name="popup_item_inv_qty"  class="input-large numeric" id="popup_item_inv_qty"> 
							<input type="hidden" value="" name="popup_item_inv_id" class="input-large numeric" id="popup_item_inv_id"> 
							<input type="text" value="" name="popup_item_qty" onkeyup="return instantsales_popup_onkeyupfortotal(event)" class="input-large numeric" id="popup_item_qty">
                        </span>
                     </div>
                 </td>
